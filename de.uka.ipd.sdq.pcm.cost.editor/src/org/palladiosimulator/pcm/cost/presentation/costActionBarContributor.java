...
/**
 * This is the action bar contributor for the cost model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
        ...
        implements ISelectionChangedListener
{
    ...
    protected IAction showPropertiesViewAction =
            new Action(CostModelEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
            {
                @Override
                public void run()
                {
                    try
                    {
                        costActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
                    }
    ...
    protected IAction refreshViewerAction =
            new Action(CostModelEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
            {
                @Override
                public boolean isEnabled()
                {
                    return costActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
                }

                @Override
                public void run()
                {
                    if (costActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
                    {
                        final Viewer viewer = ((IViewerProvider) costActionBarContributor.this.activeEditorPart)
                        .getViewer();
                        if (viewer != null)
                        {
                            viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager)
    {
        ...
        final IMenuManager submenuManager = new MenuManager(
                CostModelEditorPlugin.INSTANCE.getString("_UI_costEditor_menu"),
                "org.palladiosimulator.pcm.costMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                CostModelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                CostModelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(final IMenuManager menuManager)
    {
        ...
        submenuManager = new MenuManager(CostModelEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        this.populateManager(submenuManager, this.createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(CostModelEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
