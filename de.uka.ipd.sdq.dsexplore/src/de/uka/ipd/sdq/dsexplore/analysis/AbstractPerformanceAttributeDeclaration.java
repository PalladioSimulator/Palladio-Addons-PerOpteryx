...
public abstract class AbstractPerformanceAttributeDeclaration implements IAnalysisQualityAttributeDeclaration{
	...
	protected Dimension sloViolationsDimension;
	...
	public static final String[] qualityAttributes = {
			...
			QMLConstantsContainer.QUALITY_ATTRIBUTE_DIMENSION_SLO_VIOLATION_DEFINITION_PATH};
	...
	public AbstractPerformanceAttributeDeclaration() {
		...
		sloViolationsDimension = reader.getDimension(qualityAttributes[3]);
	}
	...
	public List<Dimension> getDimensions() {
		...
		dimensionList.add(sloViolationsDimension);
