...
public class DSEDecoder implements Decoder<DesignDecisionGenotype, PCMPhenotype> {
	...
	// FIXME: This is not compatible with the {@link
	// ResourceContainerReplicationDegree}:
	// An AllocationContext that was replicated by the
	// ResourceContainerReplicationDegree needs to be "un-replicated" if moved
	// to a not replicated server.
