...
public class DSEConstantsContainer {
	...
	public static final String ARCHITECTURE_EFFECT_SPECIFICATION_FILE = "architectureEffectSpecificationFile";
	...
	public static final String[] ARCHITECTURE_EFFECT_SPECIFICATION_EXTENSION = new String[] {"*.aes"};
