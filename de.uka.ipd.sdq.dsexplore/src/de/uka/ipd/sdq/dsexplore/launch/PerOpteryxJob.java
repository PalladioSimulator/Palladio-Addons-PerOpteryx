...
public class PerOpteryxJob extends SequentialBlackboardInteractingJob<MDSDBlackboard> implements ICompositeJob {
	...
	public void cleanup(final IProgressMonitor monitor) throws CleanupFailedException {
		...
		/*
		 * try { this.candidateConfig.getRawConfiguration().delete(); } catch
		 * (CoreException e) { throw new
		 * RollbackFailedException("Could not delete launch configuration "+this
		 * .candidateConfig.getRawConfiguration().getName(),e); }
		 */
		monitor.worked(1);
	}
