...
public class SimuLizarQualityAttributeDeclaration implements IAnalysisQualityAttributeDeclaration {
	...
	public static final String qualityAttributeUtilization = QMLConstantsContainer.QUALITY_ATTRIBUTE_DIMENSION_MAX_UTIL_DEFINITION_PATH;
	
	private Dimension responseTimeDimension;
	private Dimension sloViolationsDimension;
	private Dimension throughputDimension;
	private Dimension maxUtilization;
	...
	public SimuLizarQualityAttributeDeclaration(){
		...
		this.maxUtilization = reader.getDimension(qualityAttributeUtilization);
	...
	public List<Dimension> getDimensions() {
		...
		dimensionList.add(this.maxUtilization);
