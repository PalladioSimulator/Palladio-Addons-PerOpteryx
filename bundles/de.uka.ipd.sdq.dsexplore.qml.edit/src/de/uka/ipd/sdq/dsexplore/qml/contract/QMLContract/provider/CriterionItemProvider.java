...
public class CriterionItemProvider extends IdentifierItemProvider {
	...
	protected void addDimensionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Criterion_dimension_feature",
								"_UI_Criterion_type"),
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(QMLContractPackage.Literals.CRITERION__ASPECTS,
