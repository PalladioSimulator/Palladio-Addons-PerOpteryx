...
@Singleton
public class FcDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class BehaviourInclusionElements extends AbstractParserRuleElementFinder {
		...
		//imports+=Import* multiple?='multiple'? 'BehaviourInclusion' name=EString id=EString '{' 'description'
		//description=EString ('pointCut' '{' pointCut+=PointCut ("," pointCut+=PointCut)* '}')? 'featureCompletion'
		//featureCompletion=FeatureSelection ('advice' '{' advice+=Advice ("," advice+=Advice)* '}')? '}'
	...
	public class PointCutElements extends AbstractParserRuleElementFinder {
		...
		//{placementDescription::PointCut} 'PointCut' name=EString '{' ('placementStrategy' placementStrategy=PlacementStrategy)?
		//'}'
		public Group getGroup() { return cGroup; }
	...
	public class AdviceElements extends AbstractParserRuleElementFinder {
		...
		//'Advice' '{' 'appears' appears=Appearance ('pointCut' pointCut=[placementDescription::PointCut|EString])?
		//'placementPolicy' placementPolicy=PlacementPolicy '}'
		public Group getGroup() { return cGroup; }
	...
	public class FeatureSelectionElements extends AbstractParserRuleElementFinder {
		...
		//Completion=[FeatureCompletionModel::FeatureCompletion|EString] '(' featureLists+=FeatureList (","
	...
	public class PlacementStrategy_ImplElements extends AbstractParserRuleElementFinder {
		...
		//{placementDescription::PlacementStrategy} 'PlacementStrategy'
		public Group getGroup() { return cGroup; }
	...
	public class ExternalCallPlacementStrategyElements extends AbstractParserRuleElementFinder {
		...
		//{placementDescription::ExternalCallPlacementStrategy} 'ExternalCallPlacementStrategy' '{' ('matchingSignature'
	...
	public class InternalActionPlacementStrategyElements extends AbstractParserRuleElementFinder {
		...
		//{placementDescription::InternalActionPlacementStrategy} 'InternalActionPlacementStrategy' '{' ('forAllInternalActionsIn'
	...
	public class ControlFlowPlacementStrategyElements extends AbstractParserRuleElementFinder {
		...
		//{placementDescription::ControlFlowPlacementStrategy} 'ControlFlowPlacementStrategy' '{' ('forAllControlFlowsIn'
	...
	public class PlacementPolicyElements extends AbstractEnumRuleElementFinder {
