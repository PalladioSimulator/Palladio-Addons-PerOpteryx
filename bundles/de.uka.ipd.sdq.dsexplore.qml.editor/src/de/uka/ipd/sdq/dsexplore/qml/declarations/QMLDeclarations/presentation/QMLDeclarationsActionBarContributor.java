 ...
 * @generated
 */
public class QMLDeclarationsActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			QMLProfileEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			QMLProfileEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
