 ...
 * </p>
 * <ul>
 *   <li>{@link placementDescription.impl.FeatureSelectionImpl#getCompletion <em>Completion</em>}</li>
 *   <li>{@link placementDescription.impl.FeatureSelectionImpl#getFeatureLists <em>Feature Lists</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureSelectionImpl extends NamedElementImpl implements FeatureSelection {
	...
	protected EClass eStaticClass() {
		return PlacementDescriptionPackage.Literals.FEATURE_SELECTION;
	}
		...
		if (completion != null && completion.eIsProxy()) {
			...
			if (completion != oldCompletion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PlacementDescriptionPackage.FEATURE_SELECTION__COMPLETION, oldCompletion, completion));
			}
		}
		return completion;
	}
	...
	public void setCompletion(FeatureCompletion newCompletion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlacementDescriptionPackage.FEATURE_SELECTION__COMPLETION, oldCompletion, completion));
	}
	...
	public EList<FeatureList> getFeatureLists() {
		if (featureLists == null) {
			featureLists = new EObjectContainmentEList<FeatureList>(FeatureList.class, this, PlacementDescriptionPackage.FEATURE_SELECTION__FEATURE_LISTS);
		}
		return featureLists;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlacementDescriptionPackage.FEATURE_SELECTION__FEATURE_LISTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PlacementDescriptionPackage.FEATURE_SELECTION__COMPLETION:
