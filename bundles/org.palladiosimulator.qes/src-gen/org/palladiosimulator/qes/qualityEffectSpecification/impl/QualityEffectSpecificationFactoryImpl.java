...
public class QualityEffectSpecificationFactoryImpl extends EFactoryImpl implements QualityEffectSpecificationFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case QualityEffectSpecificationPackage.QUALITY_EFFECT_SPECIFICATION: return createQualityEffectSpecification();
  ...
  {
    QualityEffectSpecificationImpl qualityEffectSpecification = new QualityEffectSpecificationImpl();
    return qualityEffectSpecification;
  }
