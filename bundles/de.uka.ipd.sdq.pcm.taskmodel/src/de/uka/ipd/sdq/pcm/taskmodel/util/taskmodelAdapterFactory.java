...
public class taskmodelAdapterFactory extends AdapterFactoryImpl {
    ...
    protected taskmodelSwitch<Adapter> modelSwitch =
            new taskmodelSwitch<Adapter>()
            {
                ...
                {
                    return taskmodelAdapterFactory.this.createTaskAdapter();
                }

                @Override
                public Adapter caseEdge(final Edge object)
                {
                    return taskmodelAdapterFactory.this.createEdgeAdapter();
                }

                @Override
                public Adapter caseTaskList(final TaskList object)
                {
                    return taskmodelAdapterFactory.this.createTaskListAdapter();
                }

                @Override
                public Adapter caseAlternative(final Alternative object)
                {
                    return taskmodelAdapterFactory.this.createAlternativeAdapter();
                }

                @Override
                public Adapter caseAlternativeTask(final AlternativeTask object)
                {
                    return taskmodelAdapterFactory.this.createAlternativeTaskAdapter();
                }

                @Override
                public Adapter defaultCase(final EObject object)
                {
                    return taskmodelAdapterFactory.this.createEObjectAdapter();
                }
            };
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.taskmodel.Task
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.taskmodel.Edge
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.uka.ipd.sdq.pcm.taskmodel.TaskList
             * <em>Task List</em>}'. <!-- begin-user-doc --> This default implementation returns null so
     ...
     * Creates a new adapter for an object of class '
             * {@link de.uka.ipd.sdq.pcm.taskmodel.Alternative <em>Alternative</em>}'. <!-- begin-user-doc
    ...
    /**
     * Creates a new adapter for an object of class '
             * {@link de.uka.ipd.sdq.pcm.taskmodel.AlternativeTask <em>Alternative Task</em>}'. <!--
