...
public class WeavingInstruction {
	...
	/**
	 * The constructor.
	 * @param eccWithConsumedFeatures - A pair of an ECC with its corresponding provided features.
	 * @param weavingLocation - The concrete weaving location in the PCM model.
	 * @param transformationStrategy - The transformation strategy which defines the integration mechanism. 
	 * @param resourceContainer - The resource container the ECC is going to be allocated.
	 */
	 ...
	 * @return the transformation strategy which defines the integration mechanism. 
	 */
