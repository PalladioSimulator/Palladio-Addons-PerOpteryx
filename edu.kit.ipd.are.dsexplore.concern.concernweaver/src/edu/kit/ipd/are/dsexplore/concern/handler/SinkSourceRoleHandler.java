...
public class SinkSourceRoleHandler extends RoleHandler {
	...
	// @Override
	// public Optional<RequiredRole> getRequiredOpponentOf(ProvidedRole
	// providedRoleToHandle, List<RequiredRole> requiredRolesToExplore) {
	//
	// return filterRolesInstanceOf(SourceRole.class,
	// requiredRolesToExplore).filter(eachSourceRole ->
	// areConnected((SourceRole) eachSourceRole, (SinkRole)
	// providedRoleToHandle))
	// .findFirst();
	//
	// }
	//
	// @Override
	// public Optional<ProvidedRole> getProvidedOpponentOf(RequiredRole
	// requiredRoleToHandle, List<ProvidedRole> providedRolesToExplore) {
	//
	// return filterRolesInstanceOf(SinkRole.class,
	// providedRolesToExplore).filter(eachSinkRole -> areConnected((SourceRole)
	// requiredRoleToHandle, (SinkRole) eachSinkRole))
	// .findFirst();
	//
	// }
