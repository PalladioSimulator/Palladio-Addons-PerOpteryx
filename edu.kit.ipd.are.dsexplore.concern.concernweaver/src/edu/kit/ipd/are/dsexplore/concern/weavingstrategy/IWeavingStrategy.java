...
/**
 * The weaving strategy interface contains all methods that need to be implemented in order to integrate a concern solution
 * into a given PCM model according to the strategy of a class implementing this interface.
 * @author scheerer
 *
 */
public interface IWeavingStrategy {
	 ...
	 * @param weavingInstruction - The weaving instructions contains all informations necessary to perform a proper weaving process.
	 * @throws ConcernWeavingException - Will be thrown if there occurs any error during the weaving process.
	 */
