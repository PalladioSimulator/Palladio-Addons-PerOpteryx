 ...
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.QMLContractTypePackage#getEScaleOfMeasure()
 * @model
 * @generated
 */
public enum EScaleOfMeasure implements Enumerator {
	 ...
	 * @generated
	 */
	private static final EScaleOfMeasure[] VALUES_ARRAY = new EScaleOfMeasure[] { ORDINAL, NOMINAL, RATIO, };
