...
public class TaskImpl extends EObjectImpl implements Task {
    ...
    public void setProbabilityOfExecution(double newProbabilityOfExecution) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, taskmodelPackage.TASK__PROBABILITY_OF_EXECUTION,
                    oldProbabilityOfExecution, probabilityOfExecution));
    }
    ...
    public void setFailureProbability(double newFailureProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, taskmodelPackage.TASK__FAILURE_PROBABILITY,
    ...
    public void setMeanDemandedTime(double newMeanDemandedTime) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, taskmodelPackage.TASK__MEAN_DEMANDED_TIME,
                    oldMeanDemandedTime, meanDemandedTime));
    }
            ...
            if (repositorycomponent != oldRepositorycomponent)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            taskmodelPackage.TASK__REPOSITORYCOMPONENT, oldRepositorycomponent, repositorycomponent));
            }
        }
    ...
    public void setRepositorycomponent(RepositoryComponent newRepositorycomponent) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, taskmodelPackage.TASK__REPOSITORYCOMPONENT,
                    oldRepositorycomponent, repositorycomponent));
    }
    ...
    public AllocationContext getAllocationcontext() {
        if (allocationcontext != null && ((EObject) allocationcontext).eIsProxy())
        {
            ...
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, taskmodelPackage.TASK__ALLOCATIONCONTEXT,
                            oldAllocationcontext, allocationcontext));
            }
        }
    ...
    public void setAllocationcontext(AllocationContext newAllocationcontext) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, taskmodelPackage.TASK__ALLOCATIONCONTEXT,
                    oldAllocationcontext, allocationcontext));
    }
    ...
    public AbstractAction getAbstractaction() {
        if (abstractaction != null && ((EObject) abstractaction).eIsProxy())
        {
            ...
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, taskmodelPackage.TASK__ABSTRACTACTION,
    ...
    public void setAbstractaction(AbstractAction newAbstractaction) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, taskmodelPackage.TASK__ABSTRACTACTION,
                    oldAbstractaction, abstractaction));
    }
                ...
                diagnostics
                        ...
                        (
                                ...
                                EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] {
                                        "sumOfProbabilitiesMustBeOne", EObjectValidator.getObjectLabel(this, context) }),
                                new Object[] { this }));
            }
            return false;
        }
