...
public class RelationSemanticsItemProvider extends IdentifierItemProvider {
	...
	protected void addRelSemPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_RelationSemantics_relSem_feature",
						"_UI_RelationSemantics_type"),
				QMLContractTypePackage.Literals.RELATION_SEMANTICS__REL_SEM, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_RelationSemantics_type")
