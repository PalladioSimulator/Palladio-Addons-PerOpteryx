...
public class UniversalDoFSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UniversalDoFPackage.GENERIC_DO_FTO_DEGREE_OF_FREEDOM_MAP: {
				@SuppressWarnings("unchecked") Map.Entry<GenericDoF, DegreeOfFreedom> genericDoFToDegreeOfFreedomMap = (Map.Entry<GenericDoF, DegreeOfFreedom>)theEObject;
				T result = caseGenericDoFToDegreeOfFreedomMap(genericDoFToDegreeOfFreedomMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniversalDoFPackage.METAMODEL_DESCRIPTION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Generic Do FTo Degree Of Freedom Map</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Generic Do FTo Degree Of Freedom Map</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGenericDoFToDegreeOfFreedomMap(Map.Entry<GenericDoF, DegreeOfFreedom> object) {
		return null;
	}
