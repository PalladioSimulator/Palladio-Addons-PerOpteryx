 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.genericdesigndecision.impl.DecisionSpaceImpl#getDegreesOfFreedom <em>Degrees Of Freedom</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecisionSpaceImpl extends MinimalEObjectImpl.Container implements DecisionSpace {
	...
	public EList<DegreeOfFreedomInstance> getDegreesOfFreedom() {
		if (degreesOfFreedom == null) {
			degreesOfFreedom = new EObjectContainmentEList<DegreeOfFreedomInstance>(DegreeOfFreedomInstance.class, this, genericdesigndecisionPackage.DECISION_SPACE__DEGREES_OF_FREEDOM);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case genericdesigndecisionPackage.DECISION_SPACE__DEGREES_OF_FREEDOM:
