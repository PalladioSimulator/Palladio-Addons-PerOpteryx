...
import de.uka.ipd.sdq.dsexplore.genericdesigndecision.genericdesigndecision.GenericDoF.HelperOCLDefinition;
import de.uka.ipd.sdq.dsexplore.genericdesigndecision.genericdesigndecision.GenericDoF.OCLRule;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.genericdesigndecision.genericdesigndecision.GenericDoF.impl.OCLRuleImpl#getMainOclQuery <em>Main Ocl Query</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.dsexplore.genericdesigndecision.genericdesigndecision.GenericDoF.impl.OCLRuleImpl#getHelperDefinition <em>Helper Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OCLRuleImpl extends MinimalEObjectImpl.Container implements OCLRule {
	/**
	...
	protected EClass eStaticClass() {
		return GenericDoFPackage.Literals.OCL_RULE;
	}
	...
	public void setMainOclQuery(String newMainOclQuery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenericDoFPackage.OCL_RULE__MAIN_OCL_QUERY, oldMainOclQuery, mainOclQuery));
	}
	...
	public EList<HelperOCLDefinition> getHelperDefinition() {
		if (helperDefinition == null) {
			helperDefinition = new EObjectContainmentEList<HelperOCLDefinition>(HelperOCLDefinition.class, this, GenericDoFPackage.OCL_RULE__HELPER_DEFINITION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GenericDoFPackage.OCL_RULE__HELPER_DEFINITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GenericDoFPackage.OCL_RULE__MAIN_OCL_QUERY:
