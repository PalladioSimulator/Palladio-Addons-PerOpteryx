 ...
 * @generated
 */
public class PcmsupportSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PcmsupportPackage.PCM_METAMODEL_DESCRIPTION: {
				...
				if (result == null) result = caseAMetamodelDescription(pcmMetamodelDescription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PcmsupportPackage.PCMDSE_PROBLEM: {
