 ...
 *   <li>{@link genericdesigndecision.universalDoF.AMetamodelDescription#getGddof_to_dof <em>Gddof to dof</em>}</li>
 * </ul>
 *
...
public interface AMetamodelDescription extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Gddof to dof</b></em>' map.
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Gddof to dof</em>' map isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Gddof to dof</em>' map.
	 * @see genericdesigndecision.universalDoF.UniversalDoFPackage#getAMetamodelDescription_Gddof_to_dof()
	 ...
	 * @generated
	 */
	EMap<GenericDoF, DegreeOfFreedom> getGddof_to_dof();
	 ...
	 * @generated
	 */
	void evaluateMetamodel(EObject model);
