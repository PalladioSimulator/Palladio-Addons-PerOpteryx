...
public class UniversalDoFPackageImpl extends EPackageImpl implements UniversalDoFPackage {
	 ...
	 * @generated
	 */
	private EClass specificDoFEClass = null;
	 ...
	 * @generated
	 */
	public EOperation getGDoFRepository__NewGDoF__String() {
	 ...
	 * @generated
	 */
	public EOperation getAMetamodelDescription__DeleteSDoF__SpecificDoF() {
	 ...
	 * @generated
	 */
	public EOperation getAMetamodelDescription__ListSDoFs() {
		return aMetamodelDescriptionEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getAMetamodelDescription__GetSDoF__String() {
		return aMetamodelDescriptionEClass.getEOperations().get(3);
	}
	 ...
	 * @generated
	 */
	public EOperation getGenericDoF__Equals__GenericDoF() {
		return genericDoFEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getSpecificDoF() {
		return specificDoFEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSpecificDoF_Name() {
		return (EAttribute)specificDoFEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getSpecificDoF__Equals__SpecificDoF() {
		return specificDoFEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(gDoFRepositoryEClass, GDO_FREPOSITORY___NEW_GDO_F__STRING);
		...
		createEOperation(aMetamodelDescriptionEClass, AMETAMODEL_DESCRIPTION___DELETE_SDO_F__SPECIFICDOF);
		createEOperation(aMetamodelDescriptionEClass, AMETAMODEL_DESCRIPTION___LIST_SDO_FS);
		createEOperation(aMetamodelDescriptionEClass, AMETAMODEL_DESCRIPTION___GET_SDO_F__STRING);
		...
		createEOperation(genericDoFEClass, GENERIC_DO_F___EQUALS__GENERICDOF);

		specificDoFEClass = createEClass(SPECIFIC_DO_F);
		createEAttribute(specificDoFEClass, SPECIFIC_DO_F__NAME);
		createEOperation(specificDoFEClass, SPECIFIC_DO_F___EQUALS__SPECIFICDOF);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getGDoFRepository__NewGDoF__String(), ecorePackage.getEBoolean(), "newGDoF", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getAMetamodelDescription__DeleteSDoF__SpecificDoF(), ecorePackage.getEBoolean(), "deleteSDoF", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSpecificDoF(), "sdof", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getAMetamodelDescription__ListSDoFs(), this.getSpecificDoF(), "listSDoFs", 0, -1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getAMetamodelDescription__GetSDoF__String(), this.getSpecificDoF(), "getSDoF", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getGenericDoF__Equals__GenericDoF(), ecorePackage.getEBoolean(), "equals", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getGenericDoF(), "gdof", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(specificDoFEClass, SpecificDoF.class, "SpecificDoF", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSpecificDoF_Name(), ecorePackage.getEString(), "name", null, 0, 1, SpecificDoF.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getSpecificDoF__Equals__SpecificDoF(), ecorePackage.getEBoolean(), "equals", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getSpecificDoF(), "sdof", 0, 1, IS_UNIQUE, IS_ORDERED);
