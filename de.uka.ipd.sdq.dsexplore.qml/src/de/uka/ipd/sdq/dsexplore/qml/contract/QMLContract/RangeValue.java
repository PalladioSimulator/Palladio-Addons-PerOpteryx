 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.RangeValue#getRangeLimitLiteral <em>
 * Range Limit Literal</em>}</li>
...
public interface RangeValue extends EObject, Identifier {
     ...
     * <em>Range Limit Literal</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Range Limit Literal</em>' containment reference.
     ...
     * enumeration {@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.EnumRangeValueType}.
     * <!-- begin-user-doc -->
     * <p>
