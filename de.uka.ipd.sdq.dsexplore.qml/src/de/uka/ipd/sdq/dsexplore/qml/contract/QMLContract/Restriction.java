...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Restriction</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.Restriction#getOperator <em>Operator
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public interface Restriction extends AspectRequirement {
    /**
     * Returns the value of the '<em><b>Operator</b></em>' attribute. The literals are from the
     * enumeration {@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.EnumOperator}. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Operator</em>' attribute isn't clear, there really should be more
