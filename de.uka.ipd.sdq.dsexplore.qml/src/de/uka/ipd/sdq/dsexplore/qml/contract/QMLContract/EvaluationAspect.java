...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Evaluation Aspect</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * @generated
 */
public interface EvaluationAspect extends EObject, Identifier {
    /**
     * Returns the value of the '<em><b>Aspect Requirement</b></em>' containment reference. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Aspect Requirement</em>' containment reference isn't clear, there
     ...
     * {@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.EvaluationAspect#getAspectRequirement
     * <em>Aspect Requirement</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Aspect Requirement</em>' containment reference.
     ...
     * self.oclIsTypeOf(QMLContract::Frequency) implies ( self.aspectRequirement <> null implies (
     ...
     * @model annotation=
     *        "http://www.eclipse.org/uml2/1.1.0/GenModel body='self.oclIsTypeOf(QMLContract::Frequency) implies (\r\n\tself.aspectRequirement <> null implies (\r\n\t\tself.aspectRequirement.aspectRequirementLiteral.oclIsTypeOf(QMLContract::NumericLiteral)\r\n\t)\r\n)'"
     * @generated
     */
     ...
     * self.aspectRequirement.aspectRequirementLiteral.oclIsTypeOf(QMLContract::NumericLiteral)
     * implies (
     * self.aspectRequirement.aspectRequirementLiteral.oclAsType(QMLContract::NumericLiteral
     * ).value.oclAsType(Real) > 0 and
     * self.aspectRequirement.aspectRequirementLiteral.oclAsType(QMLContract
