 ...
 * <em><b>Simple QML Contract</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.impl.SimpleQMLContractImpl#getCriteria
 * <em>Criteria</em>}</li>
 * <li>
 * {@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.impl.SimpleQMLContractImpl#getContractType
...
public class SimpleQMLContractImpl extends GenericQMLContractImpl implements SimpleQMLContract {
    ...
    public EList<Criterion> getCriteria() {
        ...
        {
            this.criteria = new EObjectContainmentEList<Criterion>(Criterion.class, this,
                    QMLContractPackage.SIMPLE_QML_CONTRACT__CRITERIA);
        }
    ...
    public QMLContractType getContractType() {
        ...
        {
            final InternalEObject oldContractType = (InternalEObject) this.contractType;
            this.contractType = (QMLContractType) this.eResolveProxy(oldContractType);
            if (this.contractType != oldContractType)
            {
                if (this.eNotificationRequired()) {
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            QMLContractPackage.SIMPLE_QML_CONTRACT__CONTRACT_TYPE, oldContractType, this.contractType));
                }
            }
        }
     ...
     */
    @Override
    public void setContractType(final QMLContractType newContractType) {
        final QMLContractType oldContractType = this.contractType;
     ...
     * {@link #all_DIMENSIONs_must_be_from_same_CONTRACTTYPE(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>All DIMENSIO Ns must be from same CONTRACTTYPE</em>}' operation. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see #all_DIMENSIONs_must_be_from_same_CONTRACTTYPE(org.eclipse.emf.common.util.DiagnosticChain,
     *      java.util.Map)
     * @generated
     * @ordered
     */
     ...
     * {@link #all_DIMENSIONs_must_be_from_same_CONTRACTTYPE(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>All DIMENSIO Ns must be from same CONTRACTTYPE</em>}' invariant operation. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #all_DIMENSIONs_must_be_from_same_CONTRACTTYPE(org.eclipse.emf.common.util.DiagnosticChain,
     *      java.util.Map)
     ...
     */
    @Override
    public boolean all_DIMENSIONs_must_be_from_same_CONTRACTTYPE(final DiagnosticChain diagnostics,
        ...
        if (!EOCL_ENV.createQuery(ALL_DIMENSIO_NS_MUST_BE_FROM_SAME_CONTRACTTYPE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
                .check(this))
        {
            if (diagnostics != null)
            {
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID,
        ...
        case QMLContractPackage.SIMPLE_QML_CONTRACT__CRITERIA:
            return ((InternalEList<?>) this.getCriteria()).basicRemove(otherEnd, msgs);
        }
    ...
    public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
        ...
        case QMLContractPackage.SIMPLE_QML_CONTRACT__CONTRACT_TYPE:
            ...
            return this.basicGetContractType();
        }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case QMLContractPackage.SIMPLE_QML_CONTRACT__CRITERIA:
            ...
            this.getCriteria().addAll((Collection<? extends Criterion>) newValue);
            return;
        case QMLContractPackage.SIMPLE_QML_CONTRACT__CONTRACT_TYPE:
            this.setContractType((QMLContractType) newValue);
            return;
        }
    ...
    public void eUnset(final int featureID) {
        ...
        case QMLContractPackage.SIMPLE_QML_CONTRACT__CRITERIA:
            ...
            return;
        case QMLContractPackage.SIMPLE_QML_CONTRACT__CONTRACT_TYPE:
            this.setContractType((QMLContractType) null);
            return;
        }
