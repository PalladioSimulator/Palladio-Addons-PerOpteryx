...
public interface QMLProfileFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Simple QML Profile</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Refined QML Profile</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Usage Scenario Requirement</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
