 ...
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> A dimension type specifies the type of the elements in the dimension.
 * <!-- end-model-doc -->
 *
 * <p>
...
public interface DimensionType extends EObject, Identifier {
     ...
     * {@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.DimensionType#getRelationSemantics
     * <em>Relation Semantics</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Relation Semantics</em>' containment reference.
