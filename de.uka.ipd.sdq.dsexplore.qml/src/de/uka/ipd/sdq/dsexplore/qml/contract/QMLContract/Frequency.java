 ...
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> Defines the frequency of every element in the range. <!-- end-model-doc
 * -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.Frequency#getUpperLimit <em>Upper
 * Limit</em>}</li>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.Frequency#getLowerLimit <em>Lower
 * Limit</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Frequency extends StochasticEvaluationAspect {
     ...
     * <em>Upper Limit</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Upper Limit</em>' containment reference.
     * @see #getUpperLimit()
     * @generated
     */
     ...
     * <em>Lower Limit</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Lower Limit</em>' containment reference.
     * @see #getLowerLimit()
     * @generated
     */
