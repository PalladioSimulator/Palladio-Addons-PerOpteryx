...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Dimension Type Enum</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
 ...
 * <em>Elements</em>}</li>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.DimensionTypeEnum#getOrder
 * <em>Order</em>}</li>
 * </ul>
 * </p>
 *
...
public interface DimensionTypeEnum extends DimensionType {
     ...
     * (self.relationSemantics=null implies self.order->size()=0) and (self.order->size()=0 implies
     ...
     * @model annotation=
     *        "http://www.eclipse.org/uml2/1.1.0/GenModel body='(self.relationSemantics=null implies self.order->size()=0) and \r\n(self.order->size()=0 implies self.relationSemantics=null)'"
     * @generated
     */
    boolean ORDER_can_only_exist_with_RELATIONSEMANTICS_and_vice_versa(DiagnosticChain diagnostics,
