...
public interface Constraint extends Criterion {
	 ...
	 * self.aspects->forAll(a|a.aspectRequirement<>null and
	 * a.aspectRequirement.oclIsTypeOf(QMLContract::Restriction))
	 *
	 * @param diagnostics
	 ...
	 * @model annotation=
	 *        "http://www.eclipse.org/uml2/1.1.0/GenModel body='self.aspects->forAll(a|a.aspectRequirement<>null and a.aspectRequirement.oclIsTypeOf(QMLContract::Restriction))'"
	 * @generated
	 */
