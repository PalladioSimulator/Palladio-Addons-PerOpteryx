...
public class DimensionTypeSetImpl extends DimensionTypeImpl implements DimensionTypeSet {
	 ...
	 */
	@Override
	public boolean ORDER_can_only_exist_with_RELATIONSEMANTICS(DiagnosticChain diagnostics,
		...
		if (!EOCL_ENV.createQuery(ORDER_CAN_ONLY_EXIST_WITH_RELATIONSEMANTICS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV)
				.check(this)) {
			if (diagnostics != null) {
				diagnostics
