	...
	public void setAspectRequirement(AspectRequirement newAspectRequirement) {
		if (newAspectRequirement != aspectRequirement) {
			...
			if (aspectRequirement != null)
				msgs = ((InternalEObject) aspectRequirement).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - QMLContractPackage.EVALUATION_ASPECT__ASPECT_REQUIREMENT, null, msgs);
			if (newAspectRequirement != null)
				msgs = ((InternalEObject) newAspectRequirement).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - QMLContractPackage.EVALUATION_ASPECT__ASPECT_REQUIREMENT, null, msgs);
