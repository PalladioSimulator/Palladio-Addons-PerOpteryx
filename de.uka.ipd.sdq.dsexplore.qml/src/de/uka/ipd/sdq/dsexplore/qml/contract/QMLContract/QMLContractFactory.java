...
public interface QMLContractFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Simple QML Contract</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Percentile</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Range Value</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Mean</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Set Literal</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Refined QML Contract</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Restriction</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
