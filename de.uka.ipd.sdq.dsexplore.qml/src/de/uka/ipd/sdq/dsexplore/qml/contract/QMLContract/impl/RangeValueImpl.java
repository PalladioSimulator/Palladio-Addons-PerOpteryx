	...
	public void setRangeLimitLiteral(ValueLiteral newRangeLimitLiteral) {
		if (newRangeLimitLiteral != rangeLimitLiteral) {
			...
			if (rangeLimitLiteral != null)
				msgs = ((InternalEObject) rangeLimitLiteral).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - QMLContractPackage.RANGE_VALUE__RANGE_LIMIT_LITERAL, null, msgs);
			if (newRangeLimitLiteral != null)
				msgs = ((InternalEObject) newRangeLimitLiteral).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - QMLContractPackage.RANGE_VALUE__RANGE_LIMIT_LITERAL, null, msgs);
