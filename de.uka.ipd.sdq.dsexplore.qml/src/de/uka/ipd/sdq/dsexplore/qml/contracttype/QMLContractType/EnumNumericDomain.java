...
public enum EnumNumericDomain implements Enumerator {
    ...
    /**
     * An array of all the '<em><b>Enum Numeric Domain</b></em>' enumerators. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     */
     ...
     * @generated
     */
    public static EnumNumericDomain get(final String literal) {
        for (final EnumNumericDomain result : VALUES_ARRAY) {
     ...
     * @generated
     */
    public static EnumNumericDomain getByName(final String name) {
        for (final EnumNumericDomain result : VALUES_ARRAY) {
     ...
     * @generated
     */
    public static EnumNumericDomain get(final int value) {
        switch (value)
        {
        case REAL_VALUE:
            return REAL;
     ...
     * @generated
     */
    private EnumNumericDomain(final int value, final String name, final String literal) {
        this.value = value;
        this.name = name;
