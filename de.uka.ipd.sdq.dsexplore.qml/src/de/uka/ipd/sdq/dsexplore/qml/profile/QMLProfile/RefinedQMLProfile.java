 ...
 * '. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> A refinement must be stronger that the profile it refines.
 * <p>
 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.profile.QMLProfile.RefinedQMLProfile#getBaseProfile <em>
 * Base Profile</em>}</li>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.profile.QMLProfile.RefinedQMLProfile#getRefinedBy <em>
 * Refined By</em>}</li>
 * </ul>
 * </p>
 *
...
public interface RefinedQMLProfile extends GenericQMLProfile {
    /**
     * Returns the value of the '<em><b>Base Profile</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     ...
     * <em>Base Profile</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Base Profile</em>' reference.
     * @see #getBaseProfile()
     * @generated
     */
     ...
     * contents are of type {@link de.uka.ipd.sdq.dsexplore.qml.profile.QMLProfile.Requirement}.
     * <!-- begin-user-doc -->
     * <p>
