 ...
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> A&nbsp;requirement&nbsp;refers&nbsp;to&nbsp;an usage model. <!--
 * end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.profile.QMLProfile.Requirement#getRequireContract <em>
 * Require Contract</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Requirement extends EObject, Identifier {
    /**
     * Returns the value of the '<em><b>Require Contract</b></em>' reference list. The list contents
     * are of type {@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.GenericQMLContract}.
     * <!-- begin-user-doc -->
     * <p>
