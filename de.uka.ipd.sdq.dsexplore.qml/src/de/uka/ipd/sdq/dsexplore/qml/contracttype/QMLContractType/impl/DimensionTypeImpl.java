	...
	public void setRelationSemantics(RelationSemantics newRelationSemantics) {
		if (newRelationSemantics != relationSemantics) {
			...
			if (relationSemantics != null)
				msgs = ((InternalEObject) relationSemantics).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - QMLContractTypePackage.DIMENSION_TYPE__RELATION_SEMANTICS, null, msgs);
			if (newRelationSemantics != null)
				msgs = ((InternalEObject) newRelationSemantics).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - QMLContractTypePackage.DIMENSION_TYPE__RELATION_SEMANTICS, null, msgs);
