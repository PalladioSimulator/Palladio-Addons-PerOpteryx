 ...
 *
 * <!-- begin-model-doc -->
 * A&nbsp;refinement&nbsp;must&nbsp;be&nbsp;stronger&nbsp;that&nbsp;the&nbsp
 * ;contract&nbsp;it&nbsp;refines.
 * <p>
 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.RefinedQMLContract#getRefinedBy <em>
 * Refined By</em>}</li>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.RefinedQMLContract#getBaseContract
 * <em>Base Contract</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.QMLContractPackage#getRefinedQMLContract()
 * @model
 * @generated
 */
public interface RefinedQMLContract extends GenericQMLContract {
    /**
     * Returns the value of the '<em><b>Refined By</b></em>' containment reference list. The list
    ...
    /**
     * Returns the value of the '<em><b>Base Contract</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Base Contract</em>' reference isn't clear, there really should be
     ...
     * <em>Base Contract</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Base Contract</em>' reference.
     * @see #getBaseContract()
     * @generated
     */
    ...
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> self.baseContract <>
     * self
     *
     * @param diagnostics
