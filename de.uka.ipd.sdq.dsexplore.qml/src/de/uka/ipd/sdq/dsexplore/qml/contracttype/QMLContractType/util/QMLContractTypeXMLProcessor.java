...
public class QMLContractTypeXMLProcessor extends XMLProcessor {
    ...
    protected Map<String, Resource.Factory> getRegistrations() {
        if (this.registrations == null)
        {
            ...
            this.registrations.put(XML_EXTENSION, new QMLContractTypeResourceFactoryImpl());
            this.registrations.put(STAR_EXTENSION, new QMLContractTypeResourceFactoryImpl());
        }
