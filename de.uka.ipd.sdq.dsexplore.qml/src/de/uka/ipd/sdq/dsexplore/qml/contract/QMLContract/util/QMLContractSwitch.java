...
public class QMLContractSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		...
		case QMLContractPackage.SIMPLE_QML_CONTRACT: {
			...
			if (result == null)
				result = caseGenericQMLContract(simpleQMLContract);
			if (result == null)
				result = caseQMLDeclaration(simpleQMLContract);
			if (result == null)
				result = caseEntity(simpleQMLContract);
			if (result == null)
				result = caseIdentifier(simpleQMLContract);
			if (result == null)
				result = caseNamedElement(simpleQMLContract);
			if (result == null)
		...
		case QMLContractPackage.CRITERION: {
			...
			if (result == null)
				result = caseIdentifier(criterion);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.EVALUATION_ASPECT: {
			...
			if (result == null)
				result = caseIdentifier(evaluationAspect);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.ASPECT_REQUIREMENT: {
			...
			if (result == null)
				result = caseIdentifier(aspectRequirement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.VALUE_LITERAL: {
			...
			if (result == null)
				result = caseIdentifier(valueLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.PERCENTILE: {
			...
			if (result == null)
				result = casePointEstimator(percentile);
			if (result == null)
				result = caseStochasticEvaluationAspect(percentile);
			if (result == null)
				result = caseEvaluationAspect(percentile);
			if (result == null)
				result = caseIdentifier(percentile);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.POINT_ESTIMATOR: {
			...
			if (result == null)
				result = caseStochasticEvaluationAspect(pointEstimator);
			if (result == null)
				result = caseEvaluationAspect(pointEstimator);
			if (result == null)
				result = caseIdentifier(pointEstimator);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.STOCHASTIC_EVALUATION_ASPECT: {
			...
			if (result == null)
				result = caseEvaluationAspect(stochasticEvaluationAspect);
			if (result == null)
				result = caseIdentifier(stochasticEvaluationAspect);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.FREQUENCY: {
			...
			if (result == null)
				result = caseStochasticEvaluationAspect(frequency);
			if (result == null)
				result = caseEvaluationAspect(frequency);
			if (result == null)
				result = caseIdentifier(frequency);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.RANGE_VALUE: {
			...
			if (result == null)
				result = caseIdentifier(rangeValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.MEAN: {
			...
			if (result == null)
				result = casePointEstimator(mean);
			if (result == null)
				result = caseStochasticEvaluationAspect(mean);
			if (result == null)
				result = caseEvaluationAspect(mean);
			if (result == null)
				result = caseIdentifier(mean);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.VARIANCE: {
			...
			if (result == null)
				result = casePointEstimator(variance);
			if (result == null)
				result = caseStochasticEvaluationAspect(variance);
			if (result == null)
				result = caseEvaluationAspect(variance);
			if (result == null)
				result = caseIdentifier(variance);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.NUMERIC_LITERAL: {
			...
			if (result == null)
				result = caseValueLiteral(numericLiteral);
			if (result == null)
				result = caseIdentifier(numericLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.ENUM_LITERAL: {
			...
			if (result == null)
				result = caseValueLiteral(enumLiteral);
			if (result == null)
				result = caseIdentifier(enumLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.SET_LITERAL: {
			...
			if (result == null)
				result = caseValueLiteral(setLiteral);
			if (result == null)
				result = caseIdentifier(setLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.REFINED_QML_CONTRACT: {
			...
			if (result == null)
				result = caseGenericQMLContract(refinedQMLContract);
			if (result == null)
				result = caseQMLDeclaration(refinedQMLContract);
			if (result == null)
				result = caseEntity(refinedQMLContract);
			if (result == null)
				result = caseIdentifier(refinedQMLContract);
			if (result == null)
				result = caseNamedElement(refinedQMLContract);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.VALUE: {
			...
			if (result == null)
				result = caseDeterministicEvaluationAspect(value);
			if (result == null)
				result = caseEvaluationAspect(value);
			if (result == null)
				result = caseIdentifier(value);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.DETERMINISTIC_EVALUATION_ASPECT: {
			...
			if (result == null)
				result = caseEvaluationAspect(deterministicEvaluationAspect);
			if (result == null)
				result = caseIdentifier(deterministicEvaluationAspect);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.OBJECTIVE: {
			...
			if (result == null)
				result = caseCriterion(objective);
			if (result == null)
				result = caseIdentifier(objective);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.CONSTRAINT: {
			...
			if (result == null)
				result = caseCriterion(constraint);
			if (result == null)
		...
		case QMLContractPackage.RESTRICTION: {
			...
			if (result == null)
				result = caseAspectRequirement(restriction);
			if (result == null)
				result = caseIdentifier(restriction);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.GOAL: {
			...
			if (result == null)
				result = caseAspectRequirement(goal);
			if (result == null)
				result = caseIdentifier(goal);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.GENERIC_QML_CONTRACT: {
			...
			if (result == null)
				result = caseQMLDeclaration(genericQMLContract);
			if (result == null)
				result = caseEntity(genericQMLContract);
			if (result == null)
				result = caseIdentifier(genericQMLContract);
			if (result == null)
				result = caseNamedElement(genericQMLContract);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QMLContractPackage.SCALE_LITERAL: {
			...
			if (result == null)
				result = caseValueLiteral(scaleLiteral);
			if (result == null)
				result = caseENamedElement(scaleLiteral);
			if (result == null)
				result = caseIdentifier(scaleLiteral);
			if (result == null)
				result = caseEModelElement(scaleLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
