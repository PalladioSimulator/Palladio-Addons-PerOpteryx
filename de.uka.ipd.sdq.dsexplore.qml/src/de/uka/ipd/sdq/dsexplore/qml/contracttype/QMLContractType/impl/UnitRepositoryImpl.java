 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.impl.UnitRepositoryImpl#getUnits
 * <em>Units</em>}</li>
 * </ul>
 * </p>
 *
...
public class UnitRepositoryImpl extends IdentifierImpl implements UnitRepository {
    ...
    public EList<Unit> getUnits() {
        if (this.units == null)
        {
            this.units = new EObjectResolvingEList<Unit>(Unit.class, this,
                    QMLContractTypePackage.UNIT_REPOSITORY__UNITS);
        }
        return this.units;
    }
