...
public class QMLProfileValidator extends EObjectValidator {
	...
	public boolean validateRefinedQMLProfile(RefinedQMLProfile refinedQMLProfile, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (!validate_NoCircularContainment(refinedQMLProfile, diagnostics, context)) return false;
        ...
        if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(refinedQMLProfile, diagnostics, context);
