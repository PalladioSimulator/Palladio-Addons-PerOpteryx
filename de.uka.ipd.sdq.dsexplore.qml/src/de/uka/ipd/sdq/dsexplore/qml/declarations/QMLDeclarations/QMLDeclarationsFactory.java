...
public interface QMLDeclarationsFactory extends EFactory {
     ...
     * @generated
     */
    QMLDeclarationsFactory eINSTANCE = de.uka.ipd.sdq.dsexplore.qml.declarations.QMLDeclarations.impl.QMLDeclarationsFactoryImpl
            .init();

    /**
     * Returns a new object of class '<em>QML Declarations</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
