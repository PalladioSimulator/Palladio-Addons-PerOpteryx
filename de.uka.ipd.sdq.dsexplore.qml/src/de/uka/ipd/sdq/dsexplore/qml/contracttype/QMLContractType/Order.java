 ...
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> Orders&nbsp;two&nbsp;elements&nbsp;directly&nbsp;by&nbsp;specifying
 * one&nbsp;bigger&nbsp;than&nbsp;the&nbsp;other. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.Order#getBiggerElement <em>
 * Bigger Element</em>}</li>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.Order#getSmallerElement <em>
 * Smaller Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.QMLContractTypePackage#getOrder()
 * @model
 * @generated
 */
public interface Order extends EObject, Identifier {
    /**
     * Returns the value of the '<em><b>Bigger Element</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     ...
     * <em>Bigger Element</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Bigger Element</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Smaller Element</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     ...
     * <em>Smaller Element</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Smaller Element</em>' reference.
