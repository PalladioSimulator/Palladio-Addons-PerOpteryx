 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.impl.CriterionImpl#getDimension <em>
 * Dimension</em>}</li>
 * <li>{@link de.uka.ipd.sdq.dsexplore.qml.contract.QMLContract.impl.CriterionImpl#getAspects <em>
 * Aspects</em>}</li>
 * </ul>
 * </p>
 *
...
public abstract class CriterionImpl extends IdentifierImpl implements Criterion {
    ...
    public Dimension getDimension() {
        ...
        {
            final InternalEObject oldDimension = (InternalEObject) this.dimension;
            this.dimension = (Dimension) this.eResolveProxy(oldDimension);
            if (this.dimension != oldDimension)
            {
                if (this.eNotificationRequired()) {
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            QMLContractPackage.CRITERION__DIMENSION,
    ...
    public void setDimension(final Dimension newDimension) {
        final Dimension oldDimension = this.dimension;
        this.dimension = newDimension;
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, QMLContractPackage.CRITERION__DIMENSION,
                    oldDimension, this.dimension));
        }
    }
    ...
    public EList<EvaluationAspect> getAspects() {
        ...
        {
            this.aspects = new EObjectContainmentEList<EvaluationAspect>(EvaluationAspect.class, this,
     ...
     * {@link #Only_CONSTRAINTS_have_RESTRICTIONS(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>Only CONSTRAINTS have RESTRICTIONS</em>}' operation. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #Only_CONSTRAINTS_have_RESTRICTIONS(org.eclipse.emf.common.util.DiagnosticChain,
     *      java.util.Map)
     * @generated
     * @ordered
     */
     ...
     * {@link #Only_CONSTRAINTS_have_RESTRICTIONS(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>Only CONSTRAINTS have RESTRICTIONS</em>}' invariant operation. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see #Only_CONSTRAINTS_have_RESTRICTIONS(org.eclipse.emf.common.util.DiagnosticChain,
     *      java.util.Map)
     ...
     */
    @Override
    public boolean Only_CONSTRAINTS_have_RESTRICTIONS(final DiagnosticChain diagnostics,
        ...
        if (ONLY_CONSTRAINTS_HAVE_RESTRICTIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
        {
            ...
            try
            {
                ONLY_CONSTRAINTS_HAVE_RESTRICTIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
                        .createInvariant(ONLY_CONSTRAINTS_HAVE_RESTRICTIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
     ...
     * <em>FREQUENCY only possible if DIMENSION is ordered</em>}' operation. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     */
    @Override
    public boolean FREQUENCY_only_possible_if_DIMENSION_is_ordered(final DiagnosticChain diagnostics,
            final Map<Object, Object> context) {
     ...
     * <em>POINTESTIMATOR only for numeric dimensions</em>}' operation. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     ...
     */
    @Override
    public boolean POINTESTIMATOR_only_for_numeric_dimensions(final DiagnosticChain diagnostics,
            final Map<Object, Object> context) {
        if (POINTESTIMATOR_ONLY_FOR_NUMERIC_DIMENSIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
        {
            ...
            try
            {
                POINTESTIMATOR_ONLY_FOR_NUMERIC_DIMENSIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
                        .createInvariant(POINTESTIMATOR_ONLY_FOR_NUMERIC_DIMENSIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
            } catch (final ParserException pe)
            {
                throw new UnsupportedOperationException(pe.getLocalizedMessage());
            }
        }
        if (!EOCL_ENV.createQuery(POINTESTIMATOR_ONLY_FOR_NUMERIC_DIMENSIONS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV).check(
                this))
        {
            if (diagnostics != null)
            {
     ...
     * The cached OCL invariant for the '
     * {@link #Only_OBJECTIVES_have_GOALS(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * <em>Only OBJECTIVES have GOALS</em>}' invariant operation. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #Only_OBJECTIVES_have_GOALS(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
     * @generated
     ...
     */
    @Override
    public boolean Only_OBJECTIVES_have_GOALS(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
        if (ONLY_OBJECTIVES_HAVE_GOALS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV == null)
        {
            ...
            try
            {
                ONLY_OBJECTIVES_HAVE_GOALS__DIAGNOSTIC_CHAIN_MAP__EOCL_INV = helper
                        .createInvariant(ONLY_OBJECTIVES_HAVE_GOALS__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP);
            } catch (final ParserException pe)
            {
                throw new UnsupportedOperationException(pe.getLocalizedMessage());
            }
                ...
                (new BasicDiagnostic
                        (
                                ...
                                EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] {
                                        "Only_OBJECTIVES_have_GOALS", EObjectValidator.getObjectLabel(this, context) }),
                                        new Object[] { this }));
            }
            return false;
        }
    ...
    public NotificationChain eInverseRemove(final InternalEObject otherEnd, final int featureID,
        ...
        case QMLContractPackage.CRITERION__ASPECTS:
            return ((InternalEList<?>) this.getAspects()).basicRemove(otherEnd, msgs);
        }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        {
        case QMLContractPackage.CRITERION__DIMENSION:
            this.setDimension((Dimension) newValue);
            return;
        case QMLContractPackage.CRITERION__ASPECTS:
            this.getAspects().clear();
            this.getAspects().addAll((Collection<? extends EvaluationAspect>) newValue);
            return;
        }
