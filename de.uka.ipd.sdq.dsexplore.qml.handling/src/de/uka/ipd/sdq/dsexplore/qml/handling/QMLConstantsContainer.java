...
public class QMLConstantsContainer {
	...
	public static final String QUALITY_ATTRIBUTE_DIMENSION_MAINTAINABILITY_PATH = "platform:/plugin/de.uka.ipd.sdq.dsexplore.analysis.maintainability/Maintainability.qmlcontracttype";
	...
	public static final String[] QUALITY_ATTRIBUTE_DIMENSION_DEFINITION_PATHS = new String[] {
			...
			QUALITY_ATTRIBUTE_DIMENSION_THROUGHPUT_DEFINITION_PATH, QUALITY_ATTRIBUTE_DIMENSION_POFOD_DEFINITION_PATH,
