...
/**
 * This is the action bar contributor for the QMLProfile model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
...
implements ISelectionChangedListener {
            ...
            new Action(QMLProfileEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                QMLProfileActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
            }
            ...
            new Action(QMLProfileEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return QMLProfileActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (QMLProfileActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) QMLProfileActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                QMLProfileEditorPlugin.INSTANCE.getString("_UI_QMLProfileEditor_menu"),
                "de.uka.ipd.sdq.dsexplore.qml.profile.QMLProfileMenuID");
