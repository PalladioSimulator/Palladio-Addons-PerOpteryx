...
/**
 * This is the action bar contributor for the QMLContractType model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
...
implements ISelectionChangedListener {
            ...
            new Action(QMLProfileEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                QMLContractTypeActionBarContributor.this.getPage().showView(
            ...
            new Action(QMLProfileEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return QMLContractTypeActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (QMLContractTypeActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) QMLContractTypeActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                QMLProfileEditorPlugin.INSTANCE.getString("_UI_QMLContractTypeEditor_menu"),
                "de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractTypeMenuID");
