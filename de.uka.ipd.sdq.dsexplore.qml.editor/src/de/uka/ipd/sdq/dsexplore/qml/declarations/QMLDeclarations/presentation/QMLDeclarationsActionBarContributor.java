...
/**
 * This is the action bar contributor for the QMLDeclarations model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
...
implements ISelectionChangedListener {
            ...
            new Action(QMLProfileEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                QMLDeclarationsActionBarContributor.this.getPage().showView(
            ...
            new Action(QMLProfileEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return QMLDeclarationsActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (QMLDeclarationsActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) QMLDeclarationsActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                QMLProfileEditorPlugin.INSTANCE.getString("_UI_QMLDeclarationsEditor_menu"),
                "de.uka.ipd.sdq.dsexplore.qml.declarations.QMLDeclarationsMenuID");
