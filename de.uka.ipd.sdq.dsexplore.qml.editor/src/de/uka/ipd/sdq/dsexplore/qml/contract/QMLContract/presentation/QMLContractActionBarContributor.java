...
/**
 * This is the action bar contributor for the QMLContract model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
...
implements ISelectionChangedListener {
            ...
            new Action(QMLProfileEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                QMLContractActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
            }
            ...
            new Action(QMLProfileEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return QMLContractActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (QMLContractActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) QMLContractActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                QMLProfileEditorPlugin.INSTANCE.getString("_UI_QMLContractEditor_menu"),
                "de.uka.ipd.sdq.dsexplore.qml.contract.QMLContractMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                QMLProfileEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                QMLProfileEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
