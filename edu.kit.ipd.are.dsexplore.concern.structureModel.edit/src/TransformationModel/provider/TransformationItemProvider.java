/**
 */
package TransformationModel.provider;
...
/**
 * This is the item provider adapter for a {@link TransformationModel.Transformation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransformationItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInjectablePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformation_threshold_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformation_threshold_feature", "_UI_Transformation_type"),
				 TransformationModelPackage.Literals.TRANSFORMATION__THRESHOLD,
				 true,
				 false,
				 false,
	...
	protected void addMultiplePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformation_multiple_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformation_multiple_feature", "_UI_Transformation_type"),
				 TransformationModelPackage.Literals.TRANSFORMATION__MULTIPLE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Injectable feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInjectablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformation_injectable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformation_injectable_feature", "_UI_Transformation_type"),
				 TransformationModelPackage.Literals.TRANSFORMATION__INJECTABLE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TransformationModelPackage.Literals.TRANSFORMATION__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TransformationModelPackage.Literals.TRANSFORMATION__NAME,
				 true,
				 false,
				 false,
