...
/**
 * This is the item provider adapter for a {@link ConcernModel.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcernModelPackage.Literals.ANNOTATION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcernModelPackage.Literals.ANNOTATION__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMaxAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_maxAmount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_maxAmount_feature", "_UI_Annotation_type"),
				 ConcernModelPackage.Literals.ANNOTATION__MAX_AMOUNT,
				 true,
				 false,
				 false,
