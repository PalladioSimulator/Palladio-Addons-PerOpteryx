...
public class HelperAdapterFactory extends AdapterFactoryImpl {
	...
	protected HelperSwitch<Adapter> modelSwitch =
		new HelperSwitch<Adapter>() {
			@Override
			public Adapter caseDMLPhenotype(DMLPhenotype object) {
				return createDMLPhenotypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link dmlsupport.helper.DMLPhenotype <em>DML Phenotype</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDMLPhenotypeAdapter() {
		return null;
	}
