...
/**
 * This is the item provider adapter for a {@link strategyConfig.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcernconfigPackage.Literals.CONFIGURATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcernconfigPackage.Literals.CONFIGURATION__DEFAULT_CONFIG);
			childrenFeatures.add(ConcernconfigPackage.Literals.CONFIGURATION__CONFIG_OVERRIDES);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcernconfigPackage.Literals.CONFIGURATION__DEFAULT_CONFIG,
				 ConcernconfigFactory.eINSTANCE.createFeatureConfig()));

		newChildDescriptors.add
			(createChildParameter
				(ConcernconfigPackage.Literals.CONFIGURATION__CONFIG_OVERRIDES,
				 ConcernconfigFactory.eINSTANCE.createFeatureConfig()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			childFeature == ConcernconfigPackage.Literals.CONFIGURATION__DEFAULT_CONFIG ||
			childFeature == ConcernconfigPackage.Literals.CONFIGURATION__CONFIG_OVERRIDES;
