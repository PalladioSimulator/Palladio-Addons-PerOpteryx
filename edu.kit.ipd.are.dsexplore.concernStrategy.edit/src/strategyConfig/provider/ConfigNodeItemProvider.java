...
/**
 * This is the item provider adapter for a {@link strategyConfig.ConfigNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigNodeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcernconfigPackage.Literals.CONFIG_NODE__ORIGIN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcernconfigPackage.Literals.CONFIG_NODE__CONFIG_STATE,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcernconfigPackage.Literals.CONFIG_NODE__ATTRIBUTEVALUE);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcernconfigPackage.Literals.CONFIG_NODE__ATTRIBUTEVALUE,
				 ConcernconfigFactory.eINSTANCE.createIntegerAttributeValue()));

		newChildDescriptors.add
			(createChildParameter
				(ConcernconfigPackage.Literals.CONFIG_NODE__ATTRIBUTEVALUE,
				 ConcernconfigFactory.eINSTANCE.createDoubleAttributeValue()));

		newChildDescriptors.add
			(createChildParameter
				(ConcernconfigPackage.Literals.CONFIG_NODE__ATTRIBUTEVALUE,
				 ConcernconfigFactory.eINSTANCE.createStringAttributeValue()));

		newChildDescriptors.add
			(createChildParameter
				(ConcernconfigPackage.Literals.CONFIG_NODE__ATTRIBUTEVALUE,
				 ConcernconfigFactory.eINSTANCE.createExternalObjectAttributeValue()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return ConcernStrategyEditPlugin.INSTANCE;
	}
