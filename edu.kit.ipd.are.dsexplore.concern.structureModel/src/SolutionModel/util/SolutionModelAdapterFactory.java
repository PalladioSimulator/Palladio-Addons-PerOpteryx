...
public class SolutionModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected SolutionModelSwitch<Adapter> modelSwitch =
		new SolutionModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSolutionRepository(SolutionRepository object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link SolutionModel.Solution <em>Solution</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link SolutionModel.SolutionRepository <em>Solution Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
