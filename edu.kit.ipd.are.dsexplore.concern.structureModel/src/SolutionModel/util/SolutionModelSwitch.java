 ...
 * @generated
 */
public class SolutionModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SolutionModelPackage.SOLUTION: {
				Solution solution = (Solution)theEObject;
				T result = caseSolution(solution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SolutionModelPackage.SOLUTION_REPOSITORY: {
				SolutionRepository solutionRepository = (SolutionRepository)theEObject;
				T result = caseSolutionRepository(solutionRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSolutionRepository(SolutionRepository object) {
		return null;
	}
