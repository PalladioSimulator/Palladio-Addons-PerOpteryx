 ...
 * </p>
 * <ul>
 *   <li>{@link SolutionModel.impl.SolutionRepositoryImpl#getSolutions <em>Solutions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SolutionRepositoryImpl extends MinimalEObjectImpl.Container implements SolutionRepository {
	...
	protected EClass eStaticClass() {
		return SolutionModelPackage.Literals.SOLUTION_REPOSITORY;
	}
	...
	public EList<Solution> getSolutions() {
		if (solutions == null) {
			solutions = new EObjectContainmentEList<Solution>(Solution.class, this, SolutionModelPackage.SOLUTION_REPOSITORY__SOLUTIONS);
		}
		return solutions;
	}
