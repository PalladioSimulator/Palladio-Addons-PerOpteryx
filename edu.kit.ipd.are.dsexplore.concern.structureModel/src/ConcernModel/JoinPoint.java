...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Join Point</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see ConcernModel.ConcernModelPackage#getJoinPoint()
 * @model
 * @generated
 */
public enum JoinPoint implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Join Point</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final JoinPoint[] VALUES_ARRAY =
		new JoinPoint[] {
			SIGNATURE,
			INTERFACE,
			INTERFACE_REQUIRES,
	...
	/**
	 * A public read-only list of all the '<em><b>Join Point</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<JoinPoint> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Join Point</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static JoinPoint get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			JoinPoint result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Join Point</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static JoinPoint getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			JoinPoint result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Join Point</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static JoinPoint get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private JoinPoint(int value, String name, String literal) {
		this.value = value;
		this.name = name;
