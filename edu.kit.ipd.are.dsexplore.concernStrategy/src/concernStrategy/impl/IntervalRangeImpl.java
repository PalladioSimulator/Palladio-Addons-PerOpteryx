 ...
 * </p>
 * <ul>
 *   <li>{@link concernStrategy.impl.IntervalRangeImpl#isLowerBoundIncluded <em>Lower Bound Included</em>}</li>
 *   <li>{@link concernStrategy.impl.IntervalRangeImpl#isUpperBoundIncluded <em>Upper Bound Included</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IntervalRangeImpl extends MinimalEObjectImpl.Container implements IntervalRange {
	...
	protected EClass eStaticClass() {
		return StrategymodelPackage.Literals.INTERVAL_RANGE;
	}
	...
	public void setLowerBoundIncluded(boolean newLowerBoundIncluded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StrategymodelPackage.INTERVAL_RANGE__LOWER_BOUND_INCLUDED, oldLowerBoundIncluded, lowerBoundIncluded));
	}
	...
	public void setUpperBoundIncluded(boolean newUpperBoundIncluded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StrategymodelPackage.INTERVAL_RANGE__UPPER_BOUND_INCLUDED, oldUpperBoundIncluded, upperBoundIncluded));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StrategymodelPackage.INTERVAL_RANGE__LOWER_BOUND_INCLUDED:
				return isLowerBoundIncluded() ? Boolean.TRUE : Boolean.FALSE;
			case StrategymodelPackage.INTERVAL_RANGE__UPPER_BOUND_INCLUDED:
