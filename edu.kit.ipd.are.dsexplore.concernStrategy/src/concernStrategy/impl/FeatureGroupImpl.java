 ...
 * </p>
 * <ul>
 *   <li>{@link concernStrategy.impl.FeatureGroupImpl#getMin <em>Min</em>}</li>
 *   <li>{@link concernStrategy.impl.FeatureGroupImpl#getMax <em>Max</em>}</li>
 *   <li>{@link concernStrategy.impl.FeatureGroupImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureGroupImpl extends ChildRelationImpl implements FeatureGroup {
	...
	protected EClass eStaticClass() {
		return StrategymodelPackage.Literals.FEATURE_GROUP;
	}
	...
	public void setMin(int newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StrategymodelPackage.FEATURE_GROUP__MIN, oldMin, min));
	}
	...
	public void setMax(int newMax) {
		...
		max = newMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StrategymodelPackage.FEATURE_GROUP__MAX, oldMax, max));
	}
	...
	public EList getChildren() {
		if (children == null) {
			children = new EObjectContainmentWithInverseEList(Feature.class, this, StrategymodelPackage.FEATURE_GROUP__CHILDREN, StrategymodelPackage.FEATURE__FEATUREGROUP);
		}
		return children;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 StrategymodelValidator.FEATURE_GROUP__XO_ROR_OR_IMPLIES_CHILDREN_ARE_MANDATORY,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 StrategymodelValidator.DIAGNOSTIC_SOURCE,
						 StrategymodelValidator.FEATURE_GROUP__ALL_IMPLIES_CARDINALITIES_TO_BE_MINUS_ONE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 StrategymodelValidator.DIAGNOSTIC_SOURCE,
						 StrategymodelValidator.FEATURE_GROUP__OR_IMPLIES_CARDINALITIES_MIN_TO_BE_ONE_AND_MAX_TO_BE_MINUS_ONE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 StrategymodelValidator.DIAGNOSTIC_SOURCE,
						 StrategymodelValidator.FEATURE_GROUP__XOR_IMPLIES_CARDINALITIES_TO_BE_ONE,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StrategymodelPackage.FEATURE_GROUP__CHILDREN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StrategymodelPackage.FEATURE_GROUP__MIN:
				return new Integer(getMin());
			case StrategymodelPackage.FEATURE_GROUP__MAX:
