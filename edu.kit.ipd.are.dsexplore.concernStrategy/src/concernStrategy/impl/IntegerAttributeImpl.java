 ...
 * </p>
 * <ul>
 *   <li>{@link concernStrategy.impl.IntegerAttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerAttributeImpl extends AttributeImpl implements IntegerAttribute {
	...
	protected EClass eStaticClass() {
		return StrategymodelPackage.Literals.INTEGER_ATTRIBUTE;
	}
	...
	public void setDefaultValue(int newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StrategymodelPackage.INTEGER_ATTRIBUTE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StrategymodelPackage.INTEGER_ATTRIBUTE__DEFAULT_VALUE:
