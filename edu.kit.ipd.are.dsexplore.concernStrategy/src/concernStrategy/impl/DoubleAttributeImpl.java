 ...
 * </p>
 * <ul>
 *   <li>{@link concernStrategy.impl.DoubleAttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleAttributeImpl extends AttributeImpl implements DoubleAttribute {
	...
	protected EClass eStaticClass() {
		return StrategymodelPackage.Literals.DOUBLE_ATTRIBUTE;
	}
	...
	public void setDefaultValue(double newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StrategymodelPackage.DOUBLE_ATTRIBUTE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StrategymodelPackage.DOUBLE_ATTRIBUTE__DEFAULT_VALUE:
