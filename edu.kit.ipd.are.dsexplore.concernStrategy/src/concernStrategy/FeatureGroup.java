 ...
 * </p>
 * <ul>
 *   <li>{@link concernStrategy.FeatureGroup#getMin <em>Min</em>}</li>
 *   <li>{@link concernStrategy.FeatureGroup#getMax <em>Max</em>}</li>
 *   <li>{@link concernStrategy.FeatureGroup#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @see concernStrategy.StrategymodelPackage#getFeatureGroup()
 * @model
 * @generated
 */
public interface FeatureGroup extends ChildRelation {
	 ...
	 * @see #setMin(int)
	 * @see concernStrategy.StrategymodelPackage#getFeatureGroup_Min()
	...
	/**
	 * Sets the value of the '{@link concernStrategy.FeatureGroup#getMin <em>Min</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setMax(int)
	 * @see concernStrategy.StrategymodelPackage#getFeatureGroup_Max()
	 * @model default="1" required="true" ordered="false"
	 * @generated
	 */
	int getMax();
	...
	/**
	 * Sets the value of the '{@link concernStrategy.FeatureGroup#getMax <em>Max</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link concernStrategy.Feature#getFeaturegroup <em>Featuregroup</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see concernStrategy.StrategymodelPackage#getFeatureGroup_Children()
	 * @see concernStrategy.Feature#getFeaturegroup
	 * @model type="concernStrategy.Feature" opposite="featuregroup" containment="true" lower="2" ordered="false"
	 * @generated
	 */
	EList getChildren();
