...
public class StringAttributeValueImpl extends AttributeValueImpl implements StringAttributeValue {
	...
	protected EClass eStaticClass() {
		return ConcernconfigPackage.Literals.STRING_ATTRIBUTE_VALUE;
	}
	 ...
	 * @generated
	 */
	public boolean AttributeValueIsDefinedInFeatureAndEqualsTypeString(DiagnosticChain diagnostics, Map context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 ConcernconfigValidator.STRING_ATTRIBUTE_VALUE__ATTRIBUTE_VALUE_IS_DEFINED_IN_FEATURE_AND_EQUALS_TYPE_STRING,
