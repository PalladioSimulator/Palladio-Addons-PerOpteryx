 ...
 * {@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.Element} object. <!--
...
public class ElementItemProvider
     ...
     * @generated
     */
    public ElementItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Element"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((Element) object).getId();
        return label == null || label.length() == 0 ?
                this.getString("_UI_Element_type") :
                this.getString("_UI_Element_type") + " " + label;
    }
