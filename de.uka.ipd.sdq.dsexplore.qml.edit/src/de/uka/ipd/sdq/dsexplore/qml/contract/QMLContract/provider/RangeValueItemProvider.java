...
public class RangeValueItemProvider extends IdentifierItemProvider {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				...
				QMLContractPackage.Literals.RANGE_VALUE__TYPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_RangeValue_type") : getString("_UI_RangeValue_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(QMLContractPackage.Literals.RANGE_VALUE__RANGE_LIMIT_LITERAL, QMLContractFactory.eINSTANCE.createEnumLiteral()));

		newChildDescriptors.add(
				createChildParameter(QMLContractPackage.Literals.RANGE_VALUE__RANGE_LIMIT_LITERAL, QMLContractFactory.eINSTANCE.createSetLiteral()));
