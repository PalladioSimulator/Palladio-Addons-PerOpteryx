 ...
 * @generated
 */
public class AspectRequirementItemProvider
     ...
     * @generated
     */
    public AspectRequirementItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null)
        {
            ...
            this.childrenFeatures.add(QMLContractPackage.Literals.ASPECT_REQUIREMENT__ASPECT_REQUIREMENT_LITERAL);
        }
    ...
    public String getText(final Object object) {
        final String label = ((AspectRequirement) object).getId();
        return label == null || label.length() == 0 ?
                this.getString("_UI_AspectRequirement_type") :
                this.getString("_UI_AspectRequirement_type") + " " + label;
    }
