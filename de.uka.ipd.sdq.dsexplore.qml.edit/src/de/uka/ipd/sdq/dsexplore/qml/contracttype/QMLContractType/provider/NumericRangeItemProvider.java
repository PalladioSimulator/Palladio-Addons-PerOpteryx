...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.NumericRange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumericRangeItemProvider extends IdentifierItemProvider {
	...
	protected void addLowerLimitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_NumericRange_lowerLimit_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_NumericRange_lowerLimit_feature", "_UI_NumericRange_type"),
				QMLContractTypePackage.Literals.NUMERIC_RANGE__LOWER_LIMIT, true, false, false, ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addUpperLimitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_NumericRange_upperLimit_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_NumericRange_upperLimit_feature", "_UI_NumericRange_type"),
				QMLContractTypePackage.Literals.NUMERIC_RANGE__UPPER_LIMIT, true, false, false, ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_NumericRange_type") : getString("_UI_NumericRange_type") + " " + label;
	}
