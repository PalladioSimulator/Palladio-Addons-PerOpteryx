...
public class NumericRangeItemProvider extends IdentifierItemProvider {
	...
	protected void addLowerLimitPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_NumericRange_lowerLimit_feature",
								"_UI_NumericRange_type"),
						QMLContractTypePackage.Literals.NUMERIC_RANGE__LOWER_LIMIT, true, false, false,
	...
	protected void addUpperLimitPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_NumericRange_upperLimit_feature",
								"_UI_NumericRange_type"),
						QMLContractTypePackage.Literals.NUMERIC_RANGE__UPPER_LIMIT, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_NumericRange_type")
