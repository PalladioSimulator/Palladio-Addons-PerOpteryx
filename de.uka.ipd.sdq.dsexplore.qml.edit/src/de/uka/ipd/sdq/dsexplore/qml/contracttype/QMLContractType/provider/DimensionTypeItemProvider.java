...
public class DimensionTypeItemProvider
     ...
     * @generated
     */
    public DimensionTypeItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null)
        {
            ...
            this.childrenFeatures.add(QMLContractTypePackage.Literals.DIMENSION_TYPE__RELATION_SEMANTICS);
        }
    ...
    public String getText(final Object object) {
        final String label = ((DimensionType) object).getId();
        return label == null || label.length() == 0 ?
                this.getString("_UI_DimensionType_type") :
                this.getString("_UI_DimensionType_type") + " " + label;
    }
