 ...
 * {@link de.uka.ipd.sdq.dsexplore.qml.contracttype.QMLContractType.Unit} object. <!--
...
public class UnitItemProvider
    ...
    /**
     * This returns Unit.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Unit"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((Unit) object).getId();
        return label == null || label.length() == 0 ?
                this.getString("_UI_Unit_type") :
                this.getString("_UI_Unit_type") + " " + label;
    }
