 ...
 * @generated
 */
public class SimpleQMLProfileItemProvider
        extends GenericQMLProfileItemProvider {
    /**
     ...
     * @generated
     */
    public SimpleQMLProfileItemProvider(final AdapterFactory adapterFactory) {
    ...
    protected void addUsageModelPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add
                ...
                (((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                        ...
                        this.getString("_UI_SimpleQMLProfile_usageModel_feature"),
                        this.getString("_UI_PropertyDescriptor_description",
                                "_UI_SimpleQMLProfile_usageModel_feature",
                                "_UI_SimpleQMLProfile_type"),
                                QMLProfilePackage.Literals.SIMPLE_QML_PROFILE__USAGE_MODEL,
                                true,
                                false,
                                true,
                                null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null)
        {
            ...
            this.childrenFeatures.add(QMLProfilePackage.Literals.SIMPLE_QML_PROFILE__REQUIREMENTS);
        }
    ...
    /**
     * This returns SimpleQMLProfile.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/SimpleQMLProfile"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((SimpleQMLProfile) object).getId();
        return label == null || label.length() == 0 ?
                this.getString("_UI_SimpleQMLProfile_type") :
                this.getString("_UI_SimpleQMLProfile_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add
                ...
                (QMLProfilePackage.Literals.SIMPLE_QML_PROFILE__REQUIREMENTS,
