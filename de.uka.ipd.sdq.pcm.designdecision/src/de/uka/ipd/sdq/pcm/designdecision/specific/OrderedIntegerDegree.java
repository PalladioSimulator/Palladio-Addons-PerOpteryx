 ...
 * </p>
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.specific.OrderedIntegerDegree#getListOfIntegers
...
public interface OrderedIntegerDegree extends DiscreteDegree, OrderedDataTypeDegree {
    /**
     * Returns the value of the '<em><b>List Of Integers</b></em>' attribute list. The list contents
     * are of type {@link java.lang.Integer}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>List Of Integers</em>' attribute list isn't clear, there really
