...
public interface NumericQualityProperty extends QualityProperty {
     ...
     * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> Result Decorator for
     * Performance <!-- end-model-doc -->
     *
     ...
     *
     * @param value
     *            the new value of the '<em>Result Decorator Repository</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Confidence Interval</b></em>' reference. <!-- begin-user-doc
     * -->
     * <p>
     * If the meaning of the '<em>Confidence Interval</em>' reference isn't clear, there really
     ...
     * Sets the value of the '
     * {@link de.uka.ipd.sdq.pcm.designdecision.qualityproperties.NumericQualityProperty#getConfidenceInterval
     * <em>Confidence Interval</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Confidence Interval</em>' reference.
