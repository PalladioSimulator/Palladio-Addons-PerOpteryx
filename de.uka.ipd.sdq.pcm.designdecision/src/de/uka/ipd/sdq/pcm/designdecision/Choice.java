...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Choice</b></em>'. <!--
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> A Choice represents the choice of one value from the domain of a
 * DegreeOfFreedom. The Choice links the DegreeOfFreedom for which it makes the choice.
 * Additionally, it links one element of the domain of the DegreeOfFreedom. This linking is realised
 * in subclasses of Choice, as it may be either PCM Entities or numbers. <!-- end-model-doc -->
 *
 * <p>
 ...
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.Choice#getDegreeOfFreedomInstance
...
public interface Choice extends EObject {
    /**
     * Returns the value of the '<em><b>Is Active</b></em>' attribute. The default value is
     * <code>"true"</code>. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Is Active</em>' attribute isn't clear, there really should be more
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.pcm.designdecision.Choice#isActive
     * <em>Is Active</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.pcm.designdecision.Choice#getValue
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Degree Of Freedom Instance</em>' reference isn't clear, there
     ...
     *
     * @param value
     *            the new value of the '<em>Degree Of Freedom Instance</em>' reference.
