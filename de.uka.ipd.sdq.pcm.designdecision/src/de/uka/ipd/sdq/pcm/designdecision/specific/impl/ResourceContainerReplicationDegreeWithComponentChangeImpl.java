 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.designdecision.specific.impl.ResourceContainerReplicationDegreeWithComponentChangeImpl#getExchangeComponentRule <em>Exchange Component Rule</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceContainerReplicationDegreeWithComponentChangeImpl extends ResourceContainerReplicationDegreeImpl implements ResourceContainerReplicationDegreeWithComponentChange {
	...
	public EList<ExchangeComponentRule> getExchangeComponentRule() {
		if (exchangeComponentRule == null) {
			exchangeComponentRule = new EObjectContainmentEList<ExchangeComponentRule>(ExchangeComponentRule.class, this, specificPackage.RESOURCE_CONTAINER_REPLICATION_DEGREE_WITH_COMPONENT_CHANGE__EXCHANGE_COMPONENT_RULE);
		}
