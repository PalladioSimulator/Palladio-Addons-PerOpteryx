 ...
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.specific.impl.DiscreteRangeDegreeImpl#getTo <em>To
 * </em>}</li>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.specific.impl.DiscreteRangeDegreeImpl#getFrom <em>
 * From</em>}</li>
 * </ul>
 * </p>
 *
...
public class DiscreteRangeDegreeImpl extends RangeDegreeImpl implements DiscreteRangeDegree {
     ...
     */
    @Override
    public void setTo(final int newTo) {
        final int oldTo = this.to;
        this.to = newTo;
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, specificPackage.DISCRETE_RANGE_DEGREE__TO,
                    oldTo, this.to));
        }
    }
     ...
     */
    @Override
    public void setFrom(final int newFrom) {
        final int oldFrom = this.from;
        this.from = newFrom;
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, specificPackage.DISCRETE_RANGE_DEGREE__FROM,
                    oldFrom,
                    this.from));
        }
    }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        {
        case specificPackage.DISCRETE_RANGE_DEGREE__TO:
            this.setTo((Integer) newValue);
            return;
        case specificPackage.DISCRETE_RANGE_DEGREE__FROM:
            this.setFrom((Integer) newValue);
            return;
        }
