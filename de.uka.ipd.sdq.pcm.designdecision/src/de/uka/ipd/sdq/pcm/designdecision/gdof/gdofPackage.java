...
public interface gdofPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Required Decorator Model</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int DECORATOR_MODEL_DESCRIPTION__ID = featuremodelPackage.NAMED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int DECORATOR_MODEL_DESCRIPTION__NAME = featuremodelPackage.NAMED_ELEMENT__NAME;

	/**
	 * The feature id for the '<em><b>Refered Decorator</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DECORATOR_MODEL_DESCRIPTION__REFERED_DECORATOR = featuremodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int DECORATOR_MODEL_DESCRIPTION_FEATURE_COUNT = featuremodelPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link de.uka.ipd.sdq.pcm.designdecision.gdof.DegreeOfFreedom#getRequiredDecoratorModel <em>Required Decorator Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Required Decorator Model</em>'.
	...
	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.pcm.designdecision.gdof.DecoratorModelDescription#getReferedDecorator <em>Refered Decorator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Refered Decorator</em>'.
	 * @see de.uka.ipd.sdq.pcm.designdecision.gdof.DecoratorModelDescription#getReferedDecorator()
	 * @see #getDecoratorModelDescription()
	 * @generated
	 */
	EReference getDecoratorModelDescription_ReferedDecorator();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Required Decorator Model</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.pcm.designdecision.gdof.impl.DecoratorModelDescriptionImpl <em>Decorator Model Description</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.pcm.designdecision.gdof.impl.DecoratorModelDescriptionImpl
		 * @see de.uka.ipd.sdq.pcm.designdecision.gdof.impl.gdofPackageImpl#getDecoratorModelDescription()
		...
		/**
		 * The meta object literal for the '<em><b>Refered Decorator</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference DECORATOR_MODEL_DESCRIPTION__REFERED_DECORATOR = eINSTANCE
				.getDecoratorModelDescription_ReferedDecorator();
