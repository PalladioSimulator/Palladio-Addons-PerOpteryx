 ...
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> Candidate represents one solution candidate to the optimisation problem.
 * It contains as many choices as there are DegreeOfFreedoms. <!-- end-model-doc -->
 *
 * <p>
 ...
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.Candidate#getQualityProperty
 * <em>Quality Property</em>}</li>
 * </ul>
 *
...
public interface Candidate extends EObject, NamedElement {
    /**
     * Returns the value of the '<em><b>Choices</b></em>' containment reference list. The list
     * contents are of type {@link de.uka.ipd.sdq.pcm.designdecision.Choice}. <!-- begin-user-doc
     * -->
     * <p>
