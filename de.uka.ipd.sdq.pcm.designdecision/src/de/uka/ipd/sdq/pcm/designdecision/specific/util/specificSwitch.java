...
public class specificSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(final int classifierID, final EObject theEObject) {
        ...
        case specificPackage.RESOURCE_CONTAINER_REPLICATION_DEGREE_WITH_COMPONENT_CHANGE: {
            ...
            T result = this.caseResourceContainerReplicationDegreeWithComponentChange(
        ...
        case specificPackage.AT_NUMBER_OF_REPLICA_DEGREE: {
            final ATNumberOfReplicaDegree atNumberOfReplicaDegree = (ATNumberOfReplicaDegree) theEObject;
            T result = this.caseATNumberOfReplicaDegree(atNumberOfReplicaDegree);
            if (result == null) {
                result = this.caseDiscreteRangeDegree(atNumberOfReplicaDegree);
            }
            if (result == null) {
                result = this.caseRangeDegree(atNumberOfReplicaDegree);
            }
            if (result == null) {
                result = this.caseDiscreteDegree(atNumberOfReplicaDegree);
            }
            if (result == null) {
                result = this.caseOrderedDataTypeDegree(atNumberOfReplicaDegree);
            }
            if (result == null) {
                result = this.caseDataTypeDegree(atNumberOfReplicaDegree);
            }
            if (result == null) {
                result = this.caseDegreeOfFreedomInstance(atNumberOfReplicaDegree);
            }
            if (result == null) {
                result = this.caseNamedElement(atNumberOfReplicaDegree);
            }
            if (result == null) {
                result = this.defaultCase(theEObject);
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>AT Number Of Replica Degree</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '
     *         <em>AT Number Of Replica Degree</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseATNumberOfReplicaDegree(final ATNumberOfReplicaDegree object) {
        return null;
    }
