...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Decision Space</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> Problem represents the optimisation problem definition. It contains the
 * DegreeOfFreedoms that make up this optimisation problem. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.DecisionSpace#getDegreesOfFreedom
...
public interface DecisionSpace extends NamedElement {
    /**
     * Returns the value of the '<em><b>Degrees Of Freedom</b></em>' containment reference list. The
     * list contents are of type {@link de.uka.ipd.sdq.pcm.designdecision.DegreeOfFreedomInstance}.
     * <!-- begin-user-doc -->
     * <p>
