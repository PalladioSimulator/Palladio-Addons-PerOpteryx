...
public class gdofAdapterFactory extends AdapterFactoryImpl {
    ...
    protected gdofSwitch<Adapter> modelSwitch = new gdofSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseDecoratorModelDescription(final DecoratorModelDescription object) {
     ...
     * <em>Decorator Model Description</em>}'. <!-- begin-user-doc --> This default implementation
     * returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
