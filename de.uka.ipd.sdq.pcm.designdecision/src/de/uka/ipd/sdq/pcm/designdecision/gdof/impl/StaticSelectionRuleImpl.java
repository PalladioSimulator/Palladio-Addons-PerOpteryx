 ...
 * </p>
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.gdof.impl.StaticSelectionRuleImpl#getContextClass
...
public class StaticSelectionRuleImpl extends SelectionRuleImpl implements StaticSelectionRule {
            ...
            if (this.contextClass != oldContextClass) {
                if (this.eNotificationRequired()) {
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            gdofPackage.STATIC_SELECTION_RULE__CONTEXT_CLASS, oldContextClass, this.contextClass));
                }
            }
        }
    ...
    public void setContextClass(final EClass newContextClass) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, gdofPackage.STATIC_SELECTION_RULE__CONTEXT_CLASS,
