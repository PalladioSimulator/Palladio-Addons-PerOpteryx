...
public class StaticSelectionRuleImpl extends SelectionRuleImpl implements StaticSelectionRule {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == genericdesigndecision.genericDoF.StaticContextRule.class) {
			switch (derivedFeatureID) {
			case gdofPackage.STATIC_SELECTION_RULE__CONTEXT_CLASS:
				return GenericDoFPackage.STATIC_CONTEXT_RULE__CONTEXT_CLASS;
			default:
				return -1;
			}
		}
		...
		if (baseClass == genericdesigndecision.genericDoF.StaticSelectionRule.class) {
			switch (derivedFeatureID) {
			default:
				return -1;
			}
