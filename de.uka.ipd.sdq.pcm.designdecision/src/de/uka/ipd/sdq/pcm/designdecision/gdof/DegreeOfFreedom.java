 ...
 * </p>
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.gdof.DegreeOfFreedom#getAddedElements
 * <em>Added Elements</em>}</li>
 * <li>
 ...
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.gdof.DegreeOfFreedom#getInteractionConstraints
 * <em>Interaction Constraints</em>}</li>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.gdof.DegreeOfFreedom#getPrimaryChangeable
 * <em>Primary Changeable</em>}</li>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.gdof.DegreeOfFreedom#getRequiredDecoratorModel
 * <em>Required Decorator Model</em>}</li>
 * </ul>
 *
...
public interface DegreeOfFreedom extends NamedElement {
    /**
     * Returns the value of the '<em><b>Added Elements</b></em>' reference list. The list contents
     * are of type {@link org.eclipse.emf.ecore.EClass}. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * Returns the value of the '<em><b>Interaction Constraints</b></em>' reference list. The list
     * contents are of type {@link org.eclipse.emf.ecore.EOperation}. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * Returns the value of the '<em><b>Primary Changeable</b></em>' reference. <!-- begin-user-doc
     * -->
     * <p>
     ...
     * <em>Primary Changeable</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Primary Changeable</em>' reference.
    ...
    /**
     * Returns the value of the '<em><b>Required Decorator Model</b></em>' reference list. The list
     * contents are of type {@link de.uka.ipd.sdq.pcm.designdecision.gdof.DecoratorModelDescription}
     * . <!-- begin-user-doc -->
     * <p>
