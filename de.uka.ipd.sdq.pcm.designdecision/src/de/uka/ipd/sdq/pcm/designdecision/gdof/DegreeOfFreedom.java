...
public interface DegreeOfFreedom extends NamedElement {
	...
	/**
	 * Returns the value of the '<em><b>Required Decorator Model</b></em>' containment reference list.
	 * The list contents are of type {@link de.uka.ipd.sdq.pcm.designdecision.gdof.DecoratorModelDescription}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Required Decorator Model</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Required Decorator Model</em>' containment reference list.
