...
public interface designdecisionFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Discrete Range Choice</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Degree Of Freedom Instance</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Class Choice</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Continous Range Choice</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Decision Space</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Candidate</em>'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Returns a new object of class '<em>Candidates</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
