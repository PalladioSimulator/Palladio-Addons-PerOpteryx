...
public class PCMDSEProblemImpl extends ADSEProblemImpl implements PCMDSEProblem {
	 ...
	 * @generated NOT
	 */
	public PCMDSEProblemImpl(final DSEWorkflowConfiguration dseConfig, final EModelElement emfInstance, AMetamodelDescription ammd) throws CoreException {
    ...
    protected void initialiseProblem() {
        ...
        final List<DegreeOfFreedomInstance> dds = this.problem.getDegreesOfFreedom();
    ...
    private void determineAllocationDecisions(final List<DegreeOfFreedomInstance> dds, final DesignDecisionGenotype genotype) {
        ...
        final List<ResourceContainer> rcs = this.pcmInstance.getResourceEnvironment().getResourceContainer_ResourceEnvironment();
    ...
    private void determineProcessingRateDecisions(final List<DegreeOfFreedomInstance> dds, final DesignDecisionGenotype genotype) {
        final List<ResourceContainer> resourceContainers = this.pcmInstance.getResourceEnvironment().getResourceContainer_ResourceEnvironment();
    ...
    private DegreeOfFreedomInstance getDesignDecision(final int index){
        return this.problem.getDegreesOfFreedom().get(index);
    }

    private List<DegreeOfFreedomInstance> getDesignDecisions(){
        return this.problem.getDegreesOfFreedom();
    }
	 ...
	 */
	private DegreeOfFreedomInstance getDoFInstance(final Entity entity, final Class<? extends DegreeOfFreedomInstance> degreeClass){
	    final List<DegreeOfFreedomInstance> degrees = this.problem.getDegreesOfFreedom();
