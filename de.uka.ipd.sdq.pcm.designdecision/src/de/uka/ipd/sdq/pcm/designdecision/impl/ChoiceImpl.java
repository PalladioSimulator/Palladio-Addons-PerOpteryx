 ...
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.impl.ChoiceImpl#getDegreeOfFreedomInstance <em>
 * Degree Of Freedom Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceImpl extends EObjectImpl implements Choice {
    ...
    public void setValue(final Object newValue) {
        ...
        this.value = newValue;
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET, designdecisionPackage.CHOICE__VALUE, oldValue,
                    this.value));
        }
    }
