 ...
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> The EnumerationChoice represents a choice for a DegreeOfFreedom that has
 * a domain of PCM Entities (i.e. a EnumerationDegree).
 *
 ...
 * </p>
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.ClassChoice#getChosenValue <em>Chosen Value</em>}
 * </li>
 * </ul>
 *
...
public interface ClassChoice extends Choice {
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.pcm.designdecision.ClassChoice#getChosenValue
     * <em>Chosen Value</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Chosen Value</em>' reference.
     * @see #getChosenValue()
     * @generated
     */
