 ...
 *
 * <!-- begin-model-doc --> A boolean range: Selected or Eliminated (ignore default here). <!--
 * end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.specific.OptionalFeatureDegree#getSimple
 * <em>Simple</em>}</li>
 * </ul>
 *
...
public interface OptionalFeatureDegree extends FeatureConfigDegree {
    /**
     * Returns the value of the '<em><b>Simple</b></em>' reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Simple</em>' reference isn't clear, there really should be more of
     * a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * <em>Simple</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Simple</em>' reference.
     * @see #getSimple()
     * @generated
     */
