...
public interface gdofFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Changeable Element Description</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Value Rule</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>OCL Rule</em>'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
    ...
    /**
     * Returns a new object of class '<em>Helper OCL Definition</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Do FRepository</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Instance Selection Rule</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Static Selection Rule</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Degree Of Freedom</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Decorator Model Description</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @return a new object of class '<em>Decorator Model Description</em>'.
     * @generated
     */
