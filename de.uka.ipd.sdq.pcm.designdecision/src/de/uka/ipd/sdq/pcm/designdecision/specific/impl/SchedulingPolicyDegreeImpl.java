 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.pcm.designdecision.specific.impl.SchedulingPolicyDegreeImpl#getProcessingresourcetype
            ...
            if (this.processingresourcetype != oldProcessingresourcetype)
            {
                if (this.eNotificationRequired()) {
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            specificPackage.SCHEDULING_POLICY_DEGREE__PROCESSINGRESOURCETYPE,
