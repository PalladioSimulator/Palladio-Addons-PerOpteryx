...
public class qualitypropertiesXMLProcessor extends XMLProcessor {
    ...
    protected Map<String, Resource.Factory> getRegistrations() {
        if (this.registrations == null)
        {
            ...
            this.registrations.put(XML_EXTENSION, new qualitypropertiesResourceFactoryImpl());
            this.registrations.put(STAR_EXTENSION, new qualitypropertiesResourceFactoryImpl());
        }
