 ...
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.impl.DegreeOfFreedomInstanceImpl#getDof <em>Dof</em>
 * }</li>
 * <li>
 ...
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.impl.DegreeOfFreedomInstanceImpl#getDecoratorModel
...
public class DegreeOfFreedomInstanceImpl extends NamedElementImpl implements DegreeOfFreedomInstance {
    ...
    /**
     * The cached value of the '{@link #getDecoratorModel() <em>Decorator Model</em>}' reference
    ...
    public EList<EObject> getDecoratorModel() {
        if (this.decoratorModel == null) {
            this.decoratorModel = new EObjectResolvingEList<EObject>(EObject.class, this,
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case designdecisionPackage.DEGREE_OF_FREEDOM_INSTANCE__CHANGEABLE_ELEMENTS:
            ...
            return;
        case designdecisionPackage.DEGREE_OF_FREEDOM_INSTANCE__DECORATOR_MODEL:
            this.getDecoratorModel().clear();
            this.getDecoratorModel().addAll((Collection<? extends EObject>) newValue);
            return;
        }
    ...
    public boolean eIsSet(final int featureID) {
        ...
        case designdecisionPackage.DEGREE_OF_FREEDOM_INSTANCE__DECORATOR_MODEL:
            return this.decoratorModel != null && !this.decoratorModel.isEmpty();
        }
