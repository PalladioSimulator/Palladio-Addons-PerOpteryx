...
public class NumberOfCoresAsListDegreeImpl extends NumberOfCoresDegreeImpl implements NumberOfCoresAsListDegree {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == OrderedIntegerDegree.class) {
			switch (derivedFeatureID) {
				case specificPackage.NUMBER_OF_CORES_AS_LIST_DEGREE__LIST_OF_INTEGERS: return specificPackage.ORDERED_INTEGER_DEGREE__LIST_OF_INTEGERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == OrderedIntegerDegree.class) {
			switch (baseFeatureID) {
				case specificPackage.ORDERED_INTEGER_DEGREE__LIST_OF_INTEGERS: return specificPackage.NUMBER_OF_CORES_AS_LIST_DEGREE__LIST_OF_INTEGERS;
				default: return -1;
			}
		}
