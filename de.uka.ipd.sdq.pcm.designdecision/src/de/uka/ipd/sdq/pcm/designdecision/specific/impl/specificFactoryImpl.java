...
public class specificFactoryImpl extends EFactoryImpl implements specificFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case specificPackage.EXCHANGE_COMPONENT_RULE: return createExchangeComponentRule();
			case specificPackage.CLASS_AS_REFERENCE_DEGREE: return createClassAsReferenceDegree();
			case specificPackage.CONTINUOUS_RANGE_DEGREE: return createContinuousRangeDegree();
			case specificPackage.DISCRETE_RANGE_DEGREE: return createDiscreteRangeDegree();
			case specificPackage.ORDERED_INTEGER_DEGREE: return createOrderedIntegerDegree();
			case specificPackage.CONTINUOUS_COMPONENT_PARAM_DEGREE: return createContinuousComponentParamDegree();
			case specificPackage.CONTINUOUS_PROCESSING_RATE_DEGREE: return createContinuousProcessingRateDegree();
			case specificPackage.DISCRETE_COMPONENT_PARAM_DEGREE: return createDiscreteComponentParamDegree();
			case specificPackage.DISCRETE_PROCESSING_RATE_DEGREE: return createDiscreteProcessingRateDegree();
			case specificPackage.FEATURE_GROUP_DEGREE: return createFeatureGroupDegree();
			case specificPackage.FEATURE_SUBSET: return createFeatureSubset();
			case specificPackage.NUMBER_OF_CORES_AS_LIST_DEGREE: return createNumberOfCoresAsListDegree();
			case specificPackage.NUMBER_OF_CORES_AS_RANGE_DEGREE: return createNumberOfCoresAsRangeDegree();
			case specificPackage.OPTIONAL_FEATURE_DEGREE: return createOptionalFeatureDegree();
			case specificPackage.RESOURCE_CONTAINER_REPLICATION_DEGREE: return createResourceContainerReplicationDegree();
			case specificPackage.RESOURCE_CONTAINER_REPLICATION_DEGREE_WITH_COMPONENT_CHANGE: return createResourceContainerReplicationDegreeWithComponentChange();
			case specificPackage.RESOURCE_SELECTION_DEGREE: return createResourceSelectionDegree();
			case specificPackage.SCHEDULING_POLICY_DEGREE: return createSchedulingPolicyDegree();
			case specificPackage.STRING_COMPONENT_PARAM_DEGREE: return createStringComponentParamDegree();
			case specificPackage.ALLOCATION_DEGREE: return createAllocationDegree();
			case specificPackage.ASSEMBLED_COMPONENT_DEGREE: return createAssembledComponentDegree();
			case specificPackage.CAPACITY_DEGREE: return createCapacityDegree();
			case specificPackage.MONITORING_DEGREE: return createMonitoringDegree();
			default:
