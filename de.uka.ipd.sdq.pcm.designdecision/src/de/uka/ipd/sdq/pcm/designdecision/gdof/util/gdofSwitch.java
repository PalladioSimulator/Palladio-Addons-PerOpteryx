...
public class gdofSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case gdofPackage.CHANGEABLE_ELEMENT_DESCRIPTION: {
			...
			if (result == null)
				result = caseGenericDoF_ChangeableElementDescription(changeableElementDescription);
			if (result == null)
		...
		case gdofPackage.VALUE_RULE: {
			...
			if (result == null)
				result = caseGenericDoF_ValueRule(valueRule);
			if (result == null)
				result = caseGenericDoF_OCLRule(valueRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case gdofPackage.OCL_RULE: {
			...
			if (result == null)
				result = caseGenericDoF_OCLRule(oclRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case gdofPackage.HELPER_OCL_DEFINITION: {
			...
			if (result == null)
				result = caseGenericDoF_HelperOCLDefinition(helperOCLDefinition);
			if (result == null)
				result = caseGenericDoF_OCLRule(helperOCLDefinition);
			if (result == null)
				result = caseGenericDoF_StaticContextRule(helperOCLDefinition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case gdofPackage.STATIC_CONTEXT_RULE: {
			...
			if (result == null)
				result = caseGenericDoF_StaticContextRule(staticContextRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case gdofPackage.SELECTION_RULE: {
			...
			if (result == null)
				result = caseGenericDoF_SelectionRule(selectionRule);
			if (result == null)
				result = caseGenericDoF_OCLRule(selectionRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case gdofPackage.DO_FREPOSITORY: {
			...
			if (result == null)
				result = caseGenericDoF_DoFRepository(doFRepository);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case gdofPackage.INSTANCE_SELECTION_RULE: {
			...
			if (result == null)
				result = caseGenericDoF_InstanceSelectionRule(instanceSelectionRule);
			if (result == null)
				result = caseOCLRule(instanceSelectionRule);
			if (result == null)
				result = caseGenericDoF_SelectionRule(instanceSelectionRule);
			if (result == null)
				result = caseGenericDoF_OCLRule(instanceSelectionRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case gdofPackage.STATIC_SELECTION_RULE: {
			...
			if (result == null)
				result = caseGenericDoF_StaticSelectionRule(staticSelectionRule);
			if (result == null)
				result = caseOCLRule(staticSelectionRule);
			if (result == null)
				result = caseGenericDoF_SelectionRule(staticSelectionRule);
			if (result == null)
				result = caseGenericDoF_StaticContextRule(staticSelectionRule);
			if (result == null)
				result = caseGenericDoF_OCLRule(staticSelectionRule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseGenericDoF_ChangeableElementDescription(
	 ...
	 * @generated
	 */
	public T caseGenericDoF_OCLRule(genericdesigndecision.genericDoF.OCLRule object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGenericDoF_ValueRule(genericdesigndecision.genericDoF.ValueRule object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGenericDoF_StaticContextRule(genericdesigndecision.genericDoF.StaticContextRule object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGenericDoF_HelperOCLDefinition(genericdesigndecision.genericDoF.HelperOCLDefinition object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGenericDoF_SelectionRule(genericdesigndecision.genericDoF.SelectionRule object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGenericDoF_DoFRepository(genericdesigndecision.genericDoF.DoFRepository object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGenericDoF_InstanceSelectionRule(genericdesigndecision.genericDoF.InstanceSelectionRule object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGenericDoF_StaticSelectionRule(genericdesigndecision.genericDoF.StaticSelectionRule object) {
		return null;
	}
