 ...
 * </p>
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.gdof.impl.DegreeOfFreedomImpl#getAddedElements
 ...
 * <li>
 * {@link de.uka.ipd.sdq.pcm.designdecision.gdof.impl.DegreeOfFreedomImpl#getRequiredDecoratorModel
...
public class DegreeOfFreedomImpl extends NamedElementImpl implements DegreeOfFreedom {
    ...
    /**
     * The cached value of the '{@link #getInteractionConstraints() <em>Interaction Constraints</em>
    ...
    public void setPrimaryChangeable(final ChangeableElementDescription newPrimaryChangeable) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET,
                    gdofPackage.DEGREE_OF_FREEDOM__PRIMARY_CHANGEABLE, oldPrimaryChangeable, this.primaryChangeable));
        }
    }
    ...
    public EList<DecoratorModelDescription> getRequiredDecoratorModel() {
        if (this.requiredDecoratorModel == null) {
            this.requiredDecoratorModel = new EObjectResolvingEList<DecoratorModelDescription>(
                    DecoratorModelDescription.class, this, gdofPackage.DEGREE_OF_FREEDOM__REQUIRED_DECORATOR_MODEL);
        }
        return this.requiredDecoratorModel;
    }
    ...
    public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
        ...
        case gdofPackage.DEGREE_OF_FREEDOM__REQUIRED_DECORATOR_MODEL:
            return this.getRequiredDecoratorModel();
        }
    ...
    public void eSet(final int featureID, final Object newValue) {
        ...
        case gdofPackage.DEGREE_OF_FREEDOM__CHANGEABLE_ELEMENT_DESCRIPTIONS:
            ...
            this.getChangeableElementDescriptions()
                    .addAll((Collection<? extends ChangeableElementDescription>) newValue);
            return;
        case gdofPackage.DEGREE_OF_FREEDOM__INTERACTION_CONSTRAINTS:
        ...
        case gdofPackage.DEGREE_OF_FREEDOM__PRIMARY_CHANGEABLE:
            ...
            return;
        case gdofPackage.DEGREE_OF_FREEDOM__REQUIRED_DECORATOR_MODEL:
            this.getRequiredDecoratorModel().clear();
            this.getRequiredDecoratorModel().addAll((Collection<? extends DecoratorModelDescription>) newValue);
            return;
        }
    ...
    public boolean eIsSet(final int featureID) {
        ...
        case gdofPackage.DEGREE_OF_FREEDOM__REQUIRED_DECORATOR_MODEL:
            return this.requiredDecoratorModel != null && !this.requiredDecoratorModel.isEmpty();
        }
