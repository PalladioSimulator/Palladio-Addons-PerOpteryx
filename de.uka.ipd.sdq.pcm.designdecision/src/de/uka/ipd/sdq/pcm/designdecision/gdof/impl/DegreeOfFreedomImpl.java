...
public class DegreeOfFreedomImpl extends NamedElementImpl implements DegreeOfFreedom {
	...
	/**
	 * The cached value of the '{@link #getRequiredDecoratorModel() <em>Required Decorator Model</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<ChangeableElementDescription> getChangeableElementDescriptions() {
		if (changeableElementDescriptions == null) {
			changeableElementDescriptions = new EObjectContainmentEList<ChangeableElementDescription>(
	...
	public EList<DecoratorModelDescription> getRequiredDecoratorModel() {
		if (requiredDecoratorModel == null) {
			requiredDecoratorModel = new EObjectContainmentEList<DecoratorModelDescription>(
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case gdofPackage.DEGREE_OF_FREEDOM__REQUIRED_DECORATOR_MODEL:
			return ((InternalEList<?>) getRequiredDecoratorModel()).basicRemove(otherEnd, msgs);
		}
