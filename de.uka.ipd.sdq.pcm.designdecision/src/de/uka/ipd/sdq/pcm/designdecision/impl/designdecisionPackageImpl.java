...
public class designdecisionPackageImpl extends EPackageImpl implements designdecisionPackage {
    ...
    public void createPackageContents() {
        ...
        this.createEReference(this.degreeOfFreedomInstanceEClass, DEGREE_OF_FREEDOM_INSTANCE__DECORATOR_MODEL);
    ...
    public void initializePackageContents() {
        ...
        this.initEAttribute(this.getDiscreteRangeChoice_ChosenValue(), this.ecorePackage.getEInt(), "chosenValue", null,
                1, 1, DiscreteRangeChoice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        ...
        this.initEAttribute(this.getChoice_IsActive(), this.ecorePackage.getEBoolean(), "isActive", "true", 1, 1,
                Choice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, !IS_ORDERED);
        this.initEAttribute(this.getChoice_Value(), this.ecorePackage.getEJavaObject(), "value", null, 1, 1,
                Choice.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED,
                !IS_ORDERED);
        ...
        this.initEReference(this.getDegreeOfFreedomInstance_Dof(), thegdofPackage.getDegreeOfFreedom(), null, "dof",
                null, 1, 1, DegreeOfFreedomInstance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
        ...
        this.initEReference(this.getDegreeOfFreedomInstance_DecoratorModel(), theEcorePackage.getEObject(), null,
                "decoratorModel", null, 0, -1, DegreeOfFreedomInstance.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        this.addEOperation(this.degreeOfFreedomInstanceEClass, theEcorePackage.getEBoolean(),
        ...
        this.initEReference(this.getClassChoice_ChosenValue(), theEcorePackage.getEObject(), null, "chosenValue", null,
                1, 1, ClassChoice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
        ...
        this.initEAttribute(this.getContinousRangeChoice_ChosenValue(), this.ecorePackage.getEDouble(), "chosenValue",
                null, 1, 1, ContinousRangeChoice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
        ...
        this.initEReference(this.getCandidate_Choices(), this.getChoice(), null, "choices", null, 0, -1,
                Candidate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        this.initEReference(this.getCandidate_QualityProperty(), thequalitypropertiesPackage.getQualityProperty(), null,
