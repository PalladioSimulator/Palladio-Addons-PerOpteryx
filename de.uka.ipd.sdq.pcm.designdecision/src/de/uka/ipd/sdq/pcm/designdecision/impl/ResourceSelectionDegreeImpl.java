 ...
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcm.designdecision.impl.ResourceSelectionDegreeImpl#getProcessingresourcetype <em>Processingresourcetype</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceSelectionDegreeImpl extends ClassWithCopyDegreeImpl implements ResourceSelectionDegree {
		...
		if (processingresourcetype != null && processingresourcetype.eIsProxy()) {
			...
			if (processingresourcetype != oldProcessingresourcetype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, designdecisionPackage.RESOURCE_SELECTION_DEGREE__PROCESSINGRESOURCETYPE, oldProcessingresourcetype, processingresourcetype));
			}
		}
	...
	public void setProcessingresourcetype(ProcessingResourceType newProcessingresourcetype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, designdecisionPackage.RESOURCE_SELECTION_DEGREE__PROCESSINGRESOURCETYPE, oldProcessingresourcetype, processingresourcetype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case designdecisionPackage.RESOURCE_SELECTION_DEGREE__PROCESSINGRESOURCETYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ProcessingResourceDegree.class) {
			switch (derivedFeatureID) {
				case designdecisionPackage.RESOURCE_SELECTION_DEGREE__PROCESSINGRESOURCETYPE: return designdecisionPackage.PROCESSING_RESOURCE_DEGREE__PROCESSINGRESOURCETYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ProcessingResourceDegree.class) {
			switch (baseFeatureID) {
				case designdecisionPackage.PROCESSING_RESOURCE_DEGREE__PROCESSINGRESOURCETYPE: return designdecisionPackage.RESOURCE_SELECTION_DEGREE__PROCESSINGRESOURCETYPE;
				default: return -1;
			}
		}
