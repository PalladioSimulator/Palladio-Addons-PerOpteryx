 ...
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> Candidates is the root element for specifying a set of solutions of the
 * optimisation (or also any other candidate architecture). It contains one Candidate for each found
 * solution. <!-- end-model-doc -->
 *
 * <p>
...
public interface Candidates extends EObject {
    /**
     * Returns the value of the '<em><b>Candidate</b></em>' containment reference list. The list
     * contents are of type {@link de.uka.ipd.sdq.pcm.designdecision.Candidate}. <!-- begin-user-doc
     * -->
     * <p>
    ...
    /**
     * Returns the value of the '<em><b>Problem</b></em>' reference. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.pcm.designdecision.Candidates#getProblem
     * <em>Problem</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Problem</em>' reference.
     * @see #getProblem()
     * @generated
     */
