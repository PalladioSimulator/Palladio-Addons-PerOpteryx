...
public class specificAdapterFactory extends AdapterFactoryImpl {
    ...
    protected specificSwitch<Adapter> modelSwitch = new specificSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseATNumberOfReplicaDegree(final ATNumberOfReplicaDegree object) {
     ...
     * <em>AT Number Of Replica Degree</em>}'. <!-- begin-user-doc --> This default implementation
     * returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
