 ...
 * </p>
 * <ul>
 * <li>{@link de.uka.ipd.sdq.pcm.designdecision.gdof.InstanceSelectionRule#getContextInstance
...
public interface InstanceSelectionRule extends SelectionRule {
    /**
     * Returns the value of the '<em><b>Context Instance</b></em>' reference. <!-- begin-user-doc
     * -->
     * <p>
     * If the meaning of the '<em>Context Instance</em>' reference isn't clear, there really should
     ...
     * <em>Context Instance</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Context Instance</em>' reference.
