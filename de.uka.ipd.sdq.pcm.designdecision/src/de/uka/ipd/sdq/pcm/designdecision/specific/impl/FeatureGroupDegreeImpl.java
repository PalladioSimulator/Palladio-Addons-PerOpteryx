 ...
 * <ul>
 * <li>
 * {@link de.uka.ipd.sdq.pcm.designdecision.specific.impl.FeatureGroupDegreeImpl#getFeaturegroup
    ...
    public void setFeaturegroup(final FeatureGroup newFeaturegroup) {
        ...
        if (this.eNotificationRequired()) {
            this.eNotify(new ENotificationImpl(this, Notification.SET,
                    specificPackage.FEATURE_GROUP_DEGREE__FEATUREGROUP,
                    oldFeaturegroup, this.featuregroup));
        }
    }
