...
public interface specificPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RANGE_DEGREE__CHANGEABLE_ELEMENTS = DATA_TYPE_DEGREE__CHANGEABLE_ELEMENTS;
	 ...
	 * @ordered
	 */
	int RANGE_DEGREE__NUMBER_OF_STEPS = DATA_TYPE_DEGREE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RANGE_DEGREE_FEATURE_COUNT = DATA_TYPE_DEGREE_FEATURE_COUNT + 3;
