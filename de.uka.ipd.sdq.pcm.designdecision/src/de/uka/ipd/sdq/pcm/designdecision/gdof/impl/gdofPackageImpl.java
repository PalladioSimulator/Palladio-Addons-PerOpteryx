...
public class gdofPackageImpl extends EPackageImpl implements gdofPackage {
    ...
    public static gdofPackage init() {
        ...
        gdofPackageImpl thegdofPackage = (gdofPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof gdofPackageImpl ? EPackage.Registry.INSTANCE
                .get(eNS_URI) : new gdofPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEReference(getDegreeOfFreedom_AddedElements(), theEcorePackage.getEClass(), null, "addedElements", null, 0,
                ...
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getDegreeOfFreedom_ChangeableElementDescriptions(), this.getChangeableElementDescription(),
                null, "changeableElementDescriptions", null, 1, -1, DegreeOfFreedom.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
