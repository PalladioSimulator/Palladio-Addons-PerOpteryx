...
public class gdofPackageImpl extends EPackageImpl implements gdofPackage {
	 ...
	 */
	@Override
	public EReference getDecoratorModelDescription_ReferedDecorator() {
		return (EReference) decoratorModelDescriptionEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(decoratorModelDescriptionEClass, DECORATOR_MODEL_DESCRIPTION__REFERED_DECORATOR);
	}
	...
	public void initializePackageContents() {
		...
		decoratorModelDescriptionEClass.getESuperTypes().add(thefeaturemodelPackage.getNamedElement());
		...
		initEReference(getDecoratorModelDescription_ReferedDecorator(), theEcorePackage.getEClass(), null,
				"referedDecorator", null, 0, 1, DecoratorModelDescription.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
