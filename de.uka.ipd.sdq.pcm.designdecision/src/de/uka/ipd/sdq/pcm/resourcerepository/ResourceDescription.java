...
public interface ResourceDescription extends EObject {
    /**
     * Returns the value of the '<em><b>Fixed Processing Resource Cost Resource Description</b></em>
     ...
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Fixed Processing Resource Cost Resource Description</em>'
     ...
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Processing Resource Specification Resource Description</em>'
     *         containment reference.
     ...
     *
     * @param value
     *            the new value of the '<em>Resources Can Be Used Individually</em>' attribute.
