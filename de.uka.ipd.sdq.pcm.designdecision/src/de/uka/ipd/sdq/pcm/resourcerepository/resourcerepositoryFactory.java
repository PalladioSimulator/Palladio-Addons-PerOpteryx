...
public interface resourcerepositoryFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Resource Description Repository</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Resource Description</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
