 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.qualitypropertiesFactory
 * @model kind="package"
 * @generated
 */
public interface qualitypropertiesPackage extends EPackage {
	 ...
	 * @generated
	 */
	qualitypropertiesPackage eINSTANCE = de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.impl.qualitypropertiesPackageImpl
			.init();

	/**
	 * The meta object id for the '{@link de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.impl.NumericQualityPropertyImpl <em>Numeric Quality Property</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.impl.NumericQualityPropertyImpl
	 * @see de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.impl.qualitypropertiesPackageImpl#getNumericQualityProperty()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.NumericQualityProperty <em>Numeric Quality Property</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Numeric Quality Property</em>'.
	 * @see de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.NumericQualityProperty
	 * @generated
	 */
	EClass getNumericQualityProperty();

	/**
	 * Returns the meta object for the reference '{@link de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.NumericQualityProperty#getResultDecoratorRepository <em>Result Decorator Repository</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Result Decorator Repository</em>'.
	 * @see de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.NumericQualityProperty#getResultDecoratorRepository()
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.impl.NumericQualityPropertyImpl <em>Numeric Quality Property</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.impl.NumericQualityPropertyImpl
		 * @see de.uka.ipd.sdq.pcmsupport.designdecision.qualityproperties.impl.qualitypropertiesPackageImpl#getNumericQualityProperty()
