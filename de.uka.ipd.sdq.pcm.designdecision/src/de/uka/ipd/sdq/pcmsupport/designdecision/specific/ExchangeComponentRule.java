 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcmsupport.designdecision.specific.ExchangeComponentRule#getRepositoryComponent <em>Repository Component</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.pcmsupport.designdecision.specific.ExchangeComponentRule#getAllocationContext <em>Allocation Context</em>}</li>
 * </ul>
 *
 * @see de.uka.ipd.sdq.pcmsupport.designdecision.specific.specificPackage#getExchangeComponentRule()
 * @model
 * @generated
 */
public interface ExchangeComponentRule extends EObject {
	 ...
	 * @see de.uka.ipd.sdq.pcmsupport.designdecision.specific.specificPackage#getExchangeComponentRule_RepositoryComponent()
	 ...
	 * @see de.uka.ipd.sdq.pcmsupport.designdecision.specific.specificPackage#getExchangeComponentRule_AllocationContext()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.uka.ipd.sdq.pcmsupport.designdecision.specific.ExchangeComponentRule#getAllocationContext <em>Allocation Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
