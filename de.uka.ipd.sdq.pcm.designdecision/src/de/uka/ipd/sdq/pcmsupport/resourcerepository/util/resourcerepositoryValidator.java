 ...
 * $Id$
 */
package de.uka.ipd.sdq.pcmsupport.resourcerepository.util;
...
import de.uka.ipd.sdq.pcmsupport.resourcerepository.ResourceDescription;
import de.uka.ipd.sdq.pcmsupport.resourcerepository.ResourceDescriptionRepository;
import de.uka.ipd.sdq.pcmsupport.resourcerepository.resourcerepositoryPackage;

/**
 * <!-- begin-user-doc --> The <b>Validator</b> for the model. <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.pcmsupport.resourcerepository.resourcerepositoryPackage
 * @generated
 */
public class resourcerepositoryValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "de.uka.ipd.sdq.pcmsupport.resourcerepository";
	...
	public boolean validateResourceDescription(ResourceDescription resourceDescription, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(resourceDescription, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(resourceDescription, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryBidirectionalReferenceIsPaired(resourceDescription, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(resourceDescription, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(resourceDescription, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(resourceDescription, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(resourceDescription, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateResourceDescription_CostAndResourceMustMatch(resourceDescription, diagnostics, context);
		return result;
	}
