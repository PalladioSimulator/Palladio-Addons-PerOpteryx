 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.pcmsupport.resourcerepository.impl.ResourceDescriptionRepositoryImpl#getAvailableProcessingResources_ResourceRepository <em>Available Processing Resources Resource Repository</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceDescriptionRepositoryImpl extends EObjectImpl implements ResourceDescriptionRepository {
	...
	public EList<ResourceDescription> getAvailableProcessingResources_ResourceRepository() {
		if (availableProcessingResources_ResourceRepository == null) {
			availableProcessingResources_ResourceRepository = new EObjectContainmentEList<ResourceDescription>(
