...
public final class DesignDecisionEditorPlugin extends EMFPlugin {
	...
	public DesignDecisionEditorPlugin() {
		super(new ResourceLocator[] { CostModelEditPlugin.INSTANCE, EcoreEditPlugin.INSTANCE,
				FeaturemodelEditPlugin.INSTANCE, GenericdesigndecisionEditPlugin.INSTANCE,
				IdentifierEditPlugin.INSTANCE, PalladioComponentModelEditPlugin.INSTANCE,
				ProbabilityFunctionEditPlugin.INSTANCE, ResultdecoratorEditPlugin.INSTANCE, StoexEditPlugin.INSTANCE,
