 ...
 * @generated
 */
public class resourcerepositoryItemProviderAdapterFactory extends resourcerepositoryAdapterFactory implements
    ...
    public Adapter createResourceDescriptionRepositoryAdapter() {
        if (this.resourceDescriptionRepositoryItemProvider == null)
        {
            this.resourceDescriptionRepositoryItemProvider = new ResourceDescriptionRepositoryItemProvider(this);
        }

        return this.resourceDescriptionRepositoryItemProvider;
    }
    ...
    public void dispose() {
        if (this.resourceDescriptionRepositoryItemProvider != null) {
            this.resourceDescriptionRepositoryItemProvider.dispose();
        }
        if (this.resourceDescriptionItemProvider != null) {
