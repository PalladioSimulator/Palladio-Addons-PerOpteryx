...
public class DiscreteRangeDegreeItemProvider extends RangeDegreeItemProvider {
    ...
    protected void addToPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_DiscreteRangeDegree_to_feature",
    ...
    protected void addFromPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_DiscreteRangeDegree_from_feature",
                        "_UI_DiscreteRangeDegree_type"),
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_DiscreteRangeDegree_type")
