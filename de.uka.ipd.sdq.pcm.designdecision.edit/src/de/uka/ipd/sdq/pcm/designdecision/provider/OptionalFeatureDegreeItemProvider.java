...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pcm.designdecision.OptionalFeatureDegree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OptionalFeatureDegree_simple_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OptionalFeatureDegree_simple_feature", "_UI_OptionalFeatureDegree_type"),
				 designdecisionPackage.Literals.OPTIONAL_FEATURE_DEGREE__SIMPLE,
				 true,
				 false,
				 true,
				 null,
