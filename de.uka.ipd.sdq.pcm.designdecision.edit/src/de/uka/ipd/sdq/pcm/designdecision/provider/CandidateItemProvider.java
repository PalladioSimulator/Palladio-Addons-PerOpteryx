...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pcm.designdecision.Candidate}
...
public class CandidateItemProvider extends NamedElementItemProvider {
     ...
     * @generated
     */
    public CandidateItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(designdecisionPackage.Literals.CANDIDATE__CHOICES);
            this.childrenFeatures.add(designdecisionPackage.Literals.CANDIDATE__QUALITY_PROPERTY);
        }
    ...
    /**
     * This returns Candidate.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Candidate"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((Candidate) object).getEntityName();
        return label == null || label.length() == 0 ? this.getString("_UI_Candidate_type")
                : this.getString("_UI_Candidate_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(designdecisionPackage.Literals.CANDIDATE__CHOICES,
        ...
        newChildDescriptors.add(this.createChildParameter(designdecisionPackage.Literals.CANDIDATE__QUALITY_PROPERTY,
