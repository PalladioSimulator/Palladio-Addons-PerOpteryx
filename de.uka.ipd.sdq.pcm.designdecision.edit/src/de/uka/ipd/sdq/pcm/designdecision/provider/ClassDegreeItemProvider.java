		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClassDegree_classDesignOptions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClassDegree_classDesignOptions_feature", "_UI_ClassDegree_type"),
				 designdecisionPackage.Literals.CLASS_DEGREE__CLASS_DESIGN_OPTIONS,
				 true,
				 false,
				 true,
				 null,
