...
public class OptionalFeatureDegreeItemProvider extends FeatureConfigDegreeItemProvider {
    ...
    protected void addSimplePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_OptionalFeatureDegree_simple_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_OptionalFeatureDegree_type")
