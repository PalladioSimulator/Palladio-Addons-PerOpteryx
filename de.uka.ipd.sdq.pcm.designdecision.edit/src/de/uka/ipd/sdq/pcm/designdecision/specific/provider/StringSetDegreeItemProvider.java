		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringSetDegree_stringValues_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringSetDegree_stringValues_feature", "_UI_StringSetDegree_type"),
				 specificPackage.Literals.STRING_SET_DEGREE__STRING_VALUES,
				 true,
				 false,
				 false,
