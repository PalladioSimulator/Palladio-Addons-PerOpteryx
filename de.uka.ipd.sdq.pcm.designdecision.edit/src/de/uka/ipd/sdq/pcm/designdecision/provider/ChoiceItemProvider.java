	...
	protected void addDegreeOfFreedomInstancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Choice_degreeOfFreedomInstance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Choice_degreeOfFreedomInstance_feature", "_UI_Choice_type"),
