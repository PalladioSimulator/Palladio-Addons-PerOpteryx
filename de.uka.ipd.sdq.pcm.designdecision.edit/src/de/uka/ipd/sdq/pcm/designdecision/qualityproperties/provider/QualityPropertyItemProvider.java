...
public class QualityPropertyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addQualityValuePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_QualityProperty_qualityValue_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_QualityProperty_type")
