...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.pcm.designdecision.FeatureGroupDegree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureGroupDegreeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroupDegree_featuregroup_feature", "_UI_FeatureGroupDegree_type"),
				 designdecisionPackage.Literals.FEATURE_GROUP_DEGREE__FEATUREGROUP,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(designdecisionPackage.Literals.FEATURE_GROUP_DEGREE__DOMAIN_OF_FEATURE_CONFIG_COMBINATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(designdecisionPackage.Literals.FEATURE_GROUP_DEGREE__DOMAIN_OF_FEATURE_CONFIG_COMBINATIONS,
				 designdecisionFactory.eINSTANCE.createFeatureSubset()));
	}
