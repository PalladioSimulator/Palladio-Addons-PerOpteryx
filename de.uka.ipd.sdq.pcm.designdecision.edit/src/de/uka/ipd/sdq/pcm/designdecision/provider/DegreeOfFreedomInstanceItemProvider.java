...
public class DegreeOfFreedomInstanceItemProvider extends NamedElementItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(final Object object) {
        if (this.itemPropertyDescriptors == null) {
            ...
            this.addDecoratorModelPropertyDescriptor(object);
        }
    ...
    protected void addPrimaryChangedPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_DegreeOfFreedomInstance_primaryChanged_feature", "_UI_DegreeOfFreedomInstance_type"),
    ...
    protected void addDofPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_DegreeOfFreedomInstance_dof_feature",
    ...
    /**
     * This adds a property descriptor for the Decorator Model feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    protected void addDecoratorModelPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_DegreeOfFreedomInstance_decoratorModel_feature"),
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_DegreeOfFreedomInstance_decoratorModel_feature", "_UI_DegreeOfFreedomInstance_type"),
                designdecisionPackage.Literals.DEGREE_OF_FREEDOM_INSTANCE__DECORATOR_MODEL, true, false, true, null,
                null, null));
    }
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_DegreeOfFreedomInstance_type")
