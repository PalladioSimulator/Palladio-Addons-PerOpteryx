...
public class RangeDegreeItemProvider extends OrderedDataTypeDegreeItemProvider {
    ...
    protected void addUpperBoundIncludedPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RangeDegree_upperBoundIncluded_feature",
    ...
    protected void addLowerBoundIncludedPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RangeDegree_lowerBoundIncluded_feature",
                        "_UI_RangeDegree_type"),
    ...
    protected void addNumberOfStepsPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_RangeDegree_numberOfSteps_feature",
                        "_UI_RangeDegree_type"),
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_RangeDegree_type")
