	...
	protected void addNumberOfStepsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RangeDegree_numberOfSteps_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RangeDegree_numberOfSteps_feature", "_UI_RangeDegree_type"),
