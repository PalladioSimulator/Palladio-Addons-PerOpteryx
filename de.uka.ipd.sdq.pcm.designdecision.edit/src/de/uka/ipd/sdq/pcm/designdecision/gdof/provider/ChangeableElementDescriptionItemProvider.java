 ...
 * {@link de.uka.ipd.sdq.pcm.designdecision.gdof.ChangeableElementDescription} object. <!--
...
public class ChangeableElementDescriptionItemProvider extends NamedElementItemProvider {
    ...
    protected void addChangeablePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_ChangeableElementDescription_changeable_feature", "_UI_ChangeableElementDescription_type"),
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ChangeableElementDescription_type")
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors
                .add(this.createChildParameter(gdofPackage.Literals.CHANGEABLE_ELEMENT_DESCRIPTION__VALUE_RULE,
                        gdofFactory.eINSTANCE.createValueRule()));

        newChildDescriptors
                .add(this.createChildParameter(gdofPackage.Literals.CHANGEABLE_ELEMENT_DESCRIPTION__SELECTION_RULE,
