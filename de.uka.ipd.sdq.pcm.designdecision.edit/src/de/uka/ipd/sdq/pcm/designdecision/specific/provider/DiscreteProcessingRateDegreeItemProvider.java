...
public class DiscreteProcessingRateDegreeItemProvider extends DiscreteRangeDegreeItemProvider {
     ...
     * @generated
     */
    public DiscreteProcessingRateDegreeItemProvider(final AdapterFactory adapterFactory) {
    ...
    /**
     * This returns DiscreteProcessingRateDegree.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/DiscreteProcessingRateDegree"));
    }
    ...
    public String getText(final Object object) {
        final String label = ((DiscreteProcessingRateDegree) object).getEntityName();
        return label == null || label.length() == 0 ? this.getString("_UI_DiscreteProcessingRateDegree_type")
                : this.getString("_UI_DiscreteProcessingRateDegree_type") + " " + label;
    }
