 ...
 * {@link de.uka.ipd.sdq.pcm.designdecision.gdof.DoFRepository} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class DoFRepositoryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
     ...
     * @generated
     */
    public DoFRepositoryItemProvider(final AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(gdofPackage.Literals.DO_FREPOSITORY__DOFS);
        }
    ...
    /**
     * This returns DoFRepository.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/DoFRepository"));
    }
    ...
    public String getText(final Object object) {
        return this.getString("_UI_DoFRepository_type");
    }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(gdofPackage.Literals.DO_FREPOSITORY__DOFS,
