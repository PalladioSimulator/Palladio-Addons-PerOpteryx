...
public class DoubleQualityPropertyItemProvider extends NumericQualityPropertyItemProvider {
    ...
    protected void addValuePropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_DoubleQualityProperty_value_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_DoubleQualityProperty_type")
