...
public class DegreeOfFreedomItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(gdofPackage.Literals.DEGREE_OF_FREEDOM__REQUIRED_DECORATOR_MODEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(gdofPackage.Literals.DEGREE_OF_FREEDOM__REQUIRED_DECORATOR_MODEL,
				gdofFactory.eINSTANCE.createDecoratorModelDescription()));
	}
