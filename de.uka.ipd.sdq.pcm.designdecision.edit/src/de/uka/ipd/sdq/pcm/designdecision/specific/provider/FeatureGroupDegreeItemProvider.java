...
public class FeatureGroupDegreeItemProvider extends FeatureConfigDegreeItemProvider {
    ...
    protected void addFeaturegroupPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroupDegree_featuregroup_feature",
    ...
    public String getText(final Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_FeatureGroupDegree_type")
