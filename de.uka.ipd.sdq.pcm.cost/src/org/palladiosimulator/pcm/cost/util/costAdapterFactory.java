/**
 */
package org.palladiosimulator.pcm.cost.util;
 ...
 * 
 * @see org.palladiosimulator.pcm.cost.costPackage
 * @generated
 */
public class costAdapterFactory extends AdapterFactoryImpl
{
     ...
     * @return the adapter for the <code>target</code>.
             ...
             */
              ...
              * {@link org.palladiosimulator.pcm.cost.ComponentCost <em>Component Cost</em>}'. <!--
             ...
             /**
              * Creates a new adapter for an object of class '{@link org.palladiosimulator.pcm.cost.Cost
     ...
     * <em>Fixed Linking Resource Cost</em>}'. <!-- begin-user-doc --> This default implementation
     ...
     * @return the new adapter.
             ...
             /**
              * Creates a new adapter for an object of class '
     * {@link org.palladiosimulator.pcm.cost.LinkingResourceCost <em>Linking Resource Cost</em>}'.
              * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
              * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
              * end-user-doc -->
              * 
     ...
     * <em>Processing Resource Cost</em>}'. <!-- begin-user-doc --> This default implementation
     * returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
             ...
             /**
              * Creates a new adapter for an object of class '
              * {@link org.palladiosimulator.pcm.cost.VariableCost <em>Variable Cost</em>}'. <!--
              * begin-user-doc --> This default implementation returns null so that we can easily ignore
              * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
              * end-user-doc -->
              *
     ...
     * @return the new adapter.
             ...
             /**
              * Creates a new adapter for an object of class '
              * {@link org.palladiosimulator.pcm.cost.ScalarFunction <em>Scalar Function</em>}'. <!--
              * begin-user-doc --> This default implementation returns null so that we can easily ignore
              * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
              * end-user-doc -->
              *
             ...
             /**
              * Creates a new adapter for an object of class '
              * {@link org.palladiosimulator.pcm.cost.CostRepository <em>Cost Repository</em>}'. <!--
              * begin-user-doc --> This default implementation returns null so that we can easily ignore
              * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
              * end-user-doc -->
              *
     ...
     * <em>Component Cost Per Instance</em>}'. <!-- begin-user-doc --> This default implementation
     * returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway. <!-- end-user-doc -->
     * 
     * @return the new adapter.
