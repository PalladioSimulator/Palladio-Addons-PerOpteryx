...
public interface costFactory extends EFactory
{
     ...
     * @generated
     */
    costFactory eINSTANCE = org.palladiosimulator.pcm.cost.impl.costFactoryImpl.init();

    /**
     * Returns a new object of class '<em>Component Cost</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Fixed Linking Resource Cost</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Fixed Processing Resource Cost</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Variable Linking Resource Cost</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Scalar Function</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Cost Repository</em>'. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Component Cost Per Instance</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
