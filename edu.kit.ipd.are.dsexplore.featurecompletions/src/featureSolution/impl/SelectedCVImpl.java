 ...
 * </p>
 * <ul>
 *   <li>{@link featureSolution.impl.SelectedCVImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link featureSolution.impl.SelectedCVImpl#getComplementumVisnetis <em>Complementum Visnetis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectedCVImpl extends MinimalEObjectImpl.Container implements SelectedCV {
	...
	protected EClass eStaticClass() {
		return FeatureSolutionPackage.Literals.SELECTED_CV;
	}
	...
	public void setOptional(boolean newOptional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureSolutionPackage.SELECTED_CV__OPTIONAL, oldOptional, optional));
	}
	...
	public ComplementumVisnetis getComplementumVisnetis() {
		if (complementumVisnetis != null && complementumVisnetis.eIsProxy()) {
			...
			if (complementumVisnetis != oldComplementumVisnetis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeatureSolutionPackage.SELECTED_CV__COMPLEMENTUM_VISNETIS, oldComplementumVisnetis, complementumVisnetis));
			}
		}
	...
	public void setComplementumVisnetis(ComplementumVisnetis newComplementumVisnetis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureSolutionPackage.SELECTED_CV__COMPLEMENTUM_VISNETIS, oldComplementumVisnetis, complementumVisnetis));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeatureSolutionPackage.SELECTED_CV__OPTIONAL:
				return isOptional();
			case FeatureSolutionPackage.SELECTED_CV__COMPLEMENTUM_VISNETIS:
