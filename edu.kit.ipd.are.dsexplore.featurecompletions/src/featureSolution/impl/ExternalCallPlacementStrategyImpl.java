 ...
 * </p>
 * <ul>
 *   <li>{@link featureSolution.impl.ExternalCallPlacementStrategyImpl#getMatchingSignature <em>Matching Signature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalCallPlacementStrategyImpl extends PlacementStrategyImpl implements ExternalCallPlacementStrategy {
	...
	protected EClass eStaticClass() {
		return FeatureSolutionPackage.Literals.EXTERNAL_CALL_PLACEMENT_STRATEGY;
	}
		...
		if (matchingSignature != null && ((EObject)matchingSignature).eIsProxy()) {
			...
			if (matchingSignature != oldMatchingSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeatureSolutionPackage.EXTERNAL_CALL_PLACEMENT_STRATEGY__MATCHING_SIGNATURE, oldMatchingSignature, matchingSignature));
			}
		}
	...
	public void setMatchingSignature(Signature newMatchingSignature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureSolutionPackage.EXTERNAL_CALL_PLACEMENT_STRATEGY__MATCHING_SIGNATURE, oldMatchingSignature, matchingSignature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeatureSolutionPackage.EXTERNAL_CALL_PLACEMENT_STRATEGY__MATCHING_SIGNATURE:
