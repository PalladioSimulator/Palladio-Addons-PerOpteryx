 ...
 * </p>
 * <ul>
 *   <li>{@link featureObjective.impl.IntegerIntervalRangeImpl#getTo <em>To</em>}</li>
 *   <li>{@link featureObjective.impl.IntegerIntervalRangeImpl#getFrom <em>From</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerIntervalRangeImpl extends IntervalRangeImpl implements IntegerIntervalRange {
	...
	public void setTo(int newTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureObjectivePackage.INTEGER_INTERVAL_RANGE__TO, oldTo, to));
	}
	...
	public void setFrom(int newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureObjectivePackage.INTEGER_INTERVAL_RANGE__FROM, oldFrom, from));
	}
