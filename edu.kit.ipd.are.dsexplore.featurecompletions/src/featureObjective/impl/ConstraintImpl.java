 ...
 * </p>
 * <ul>
 *   <li>{@link featureObjective.impl.ConstraintImpl#getSource <em>Source</em>}</li>
 *   <li>{@link featureObjective.impl.ConstraintImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link featureObjective.impl.ConstraintImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConstraintImpl extends NamedElementImpl implements Constraint {
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeatureObjectivePackage.CONSTRAINT__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Feature newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureObjectivePackage.CONSTRAINT__SOURCE, oldSource, source));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureObjectivePackage.CONSTRAINT__DESCRIPTION, oldDescription, description));
	}
