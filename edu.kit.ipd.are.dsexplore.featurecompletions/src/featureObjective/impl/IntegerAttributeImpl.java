 ...
 * </p>
 * <ul>
 *   <li>{@link featureObjective.impl.IntegerAttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerAttributeImpl extends AttributeImpl implements IntegerAttribute {
	...
	public void setDefaultValue(int newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureObjectivePackage.INTEGER_ATTRIBUTE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
