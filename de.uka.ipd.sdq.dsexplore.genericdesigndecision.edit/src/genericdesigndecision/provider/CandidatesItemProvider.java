...
/**
 * This is the item provider adapter for a {@link genericdesigndecision.Candidates} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CandidatesItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Candidates_problem_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Candidates_problem_feature", "_UI_Candidates_type"),
				 GenericdesigndecisionPackage.Literals.CANDIDATES__PROBLEM,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GenericdesigndecisionPackage.Literals.CANDIDATES__CANDIDATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GenericdesigndecisionPackage.Literals.CANDIDATES__CANDIDATE,
				 GenericdesigndecisionFactory.eINSTANCE.createCandidate()));
	}
