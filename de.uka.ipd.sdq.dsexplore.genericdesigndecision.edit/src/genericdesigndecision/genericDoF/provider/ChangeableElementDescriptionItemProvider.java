...
/**
 * This is the item provider adapter for a {@link genericdesigndecision.genericDoF.ChangeableElementDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChangeableElementDescriptionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenericDoFPackage.Literals.CHANGEABLE_ELEMENT_DESCRIPTION__CHANGEABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GenericDoFPackage.Literals.CHANGEABLE_ELEMENT_DESCRIPTION__VALUE_RULE);
			childrenFeatures.add(GenericDoFPackage.Literals.CHANGEABLE_ELEMENT_DESCRIPTION__SELECTION_RULE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GenericDoFPackage.Literals.CHANGEABLE_ELEMENT_DESCRIPTION__VALUE_RULE,
				 GenericDoFFactory.eINSTANCE.createValueRule()));

		newChildDescriptors.add
			(createChildParameter
				(GenericDoFPackage.Literals.CHANGEABLE_ELEMENT_DESCRIPTION__SELECTION_RULE,
				 GenericDoFFactory.eINSTANCE.createInstanceSelectionRule()));

		newChildDescriptors.add
			(createChildParameter
				(GenericDoFPackage.Literals.CHANGEABLE_ELEMENT_DESCRIPTION__SELECTION_RULE,
				 GenericDoFFactory.eINSTANCE.createStaticSelectionRule()));
	}
