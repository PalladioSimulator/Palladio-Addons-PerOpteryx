...
/**
 * This is the action bar contributor for the gdof model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class gdofActionBarContributor
...
implements ISelectionChangedListener {
            ...
            new Action(DesignDecisionEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                gdofActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
            }
            ...
            new Action(DesignDecisionEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        {
            return gdofActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run()
        {
            if (gdofActionBarContributor.this.activeEditorPart instanceof IViewerProvider)
            {
                final Viewer viewer = ((IViewerProvider) gdofActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
