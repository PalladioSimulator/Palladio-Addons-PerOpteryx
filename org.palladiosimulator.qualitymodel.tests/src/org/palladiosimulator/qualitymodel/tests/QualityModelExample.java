...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>qualitymodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class QualityModelExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.qualitymodel"));
				Nqr root = QualityModelFactory.eINSTANCE.createNqr();
