...
public class QualityEffectSpecificationAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected QualityEffectSpecificationSwitch<Adapter> modelSwitch =
    new QualityEffectSpecificationSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseQualityEffectSpecification(QualityEffectSpecification object)
      {
        return createQualityEffectSpecificationAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.palladiosimulator.qes.qualityEffectSpecification.QualityEffectSpecification <em>Quality Effect Specification</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
