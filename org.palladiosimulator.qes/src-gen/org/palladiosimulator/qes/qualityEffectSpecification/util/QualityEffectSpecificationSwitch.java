...
public class QualityEffectSpecificationSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        QualityEffectSpecification qualityEffectSpecification = (QualityEffectSpecification)theEObject;
        T result = caseQualityEffectSpecification(qualityEffectSpecification);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case QualityEffectSpecificationPackage.ANNOTATION:
      {
        ...
        if (result == null) result = caseComponentProperty(annotation);
        if (result == null) result = caseRoleProperty(annotation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Quality Effect Specification</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Quality Effect Specification</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseQualityEffectSpecification(QualityEffectSpecification object)
  {
    return null;
  }
