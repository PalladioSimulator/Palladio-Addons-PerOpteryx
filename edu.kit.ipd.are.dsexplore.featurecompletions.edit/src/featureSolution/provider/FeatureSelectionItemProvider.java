	...
	protected void addFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureSelection_Features_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureSelection_Features_feature", "_UI_FeatureSelection_type"),
				 FeatureSolutionPackage.Literals.FEATURE_SELECTION__FEATURES,
				 true,
				 false,
				 true,
				 null,
