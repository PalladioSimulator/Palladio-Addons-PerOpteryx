...
public class ExtensionInclusionItemProvider extends InclusionMechanismItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FeatureSolutionPackage.Literals.EXTENSION_INCLUSION__PLACEMENT_STRATEGY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FeatureSolutionPackage.Literals.EXTENSION_INCLUSION__PLACEMENT_STRATEGY,
