...
/**
 * This is the item provider adapter for a {@link placementDescription.PointCut} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointCutItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PlacementDescriptionPackage.Literals.POINT_CUT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlacementDescriptionPackage.Literals.POINT_CUT__PLACEMENT_STRATEGY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlacementDescriptionPackage.Literals.POINT_CUT__PLACEMENT_STRATEGY,
				 PlacementDescriptionFactory.eINSTANCE.createPlacementStrategy()));

		newChildDescriptors.add
			(createChildParameter
				(PlacementDescriptionPackage.Literals.POINT_CUT__PLACEMENT_STRATEGY,
				 PlacementDescriptionFactory.eINSTANCE.createExternalCallPlacementStrategy()));

		newChildDescriptors.add
			(createChildParameter
				(PlacementDescriptionPackage.Literals.POINT_CUT__PLACEMENT_STRATEGY,
				 PlacementDescriptionFactory.eINSTANCE.createInternalActionPlacementStrategy()));

		newChildDescriptors.add
			(createChildParameter
				(PlacementDescriptionPackage.Literals.POINT_CUT__PLACEMENT_STRATEGY,
				 PlacementDescriptionFactory.eINSTANCE.createControlFlowPlacementStrategy()));
	}
