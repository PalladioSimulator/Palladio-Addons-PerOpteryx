...
/**
 * This is the item provider adapter for a {@link placementDescription.FeatureSelection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureSelectionItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PlacementDescriptionPackage.Literals.FEATURE_SELECTION__COMPLETION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlacementDescriptionPackage.Literals.FEATURE_SELECTION__FEATURE_LISTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlacementDescriptionPackage.Literals.FEATURE_SELECTION__FEATURE_LISTS,
				 PlacementDescriptionFactory.eINSTANCE.createFeatureList()));
	}
