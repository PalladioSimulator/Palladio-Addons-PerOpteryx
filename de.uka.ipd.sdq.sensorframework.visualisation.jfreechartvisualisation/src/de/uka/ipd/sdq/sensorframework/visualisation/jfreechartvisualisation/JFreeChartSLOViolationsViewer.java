...
private int count = 0;
	...
	protected void initChart() {
		chart = ChartFactory.createScatterPlot("SLO Violations", "No. of Measurements", "Number Of SLO Violations", dataset, PlotOrientation.VERTICAL, true, true, true);
//		NumberAxis xAxis = (NumberAxis) chart.getXYPlot().getRangeAxis();
//		xAxis.setRange(0,10);
//		xAxis.setTickUnit(new NumberTickUnit(1));
//		
//		NumberAxis rangeAxis = (NumberAxis) chart.getXYPlot().getDomainAxis();
//		rangeAxis.setAutoRangeIncludesZero(false);
//		rangeAxis.setAutoRangeMinimumSize(1e-16);
