...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>placementDescription</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class PlacementDescriptionExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.placementdescription"));
				PlacementStrategy root = PlacementDescriptionFactory.eINSTANCE.createPlacementStrategy();
