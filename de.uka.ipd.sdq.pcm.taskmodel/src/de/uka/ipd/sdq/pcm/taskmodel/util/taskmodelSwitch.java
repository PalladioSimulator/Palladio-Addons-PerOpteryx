...
public class taskmodelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case taskmodelPackage.ALTERNATIVE_TASK: {
				AlternativeTask alternativeTask = (AlternativeTask)theEObject;
				T result = caseAlternativeTask(alternativeTask);
				if (result == null) result = caseTask(alternativeTask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseAlternativeTask(AlternativeTask object) {
		return null;
	}
