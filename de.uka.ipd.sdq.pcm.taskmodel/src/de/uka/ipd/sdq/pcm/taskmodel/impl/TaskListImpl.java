...
public class TaskListImpl extends EObjectImpl implements TaskList {
    ...
    public EList<Task> getTask_TaskList() {
        ...
        {
            task_TaskList = new EObjectContainmentEList<Task>(Task.class, this,
                    taskmodelPackage.TASK_LIST__TASK_TASK_LIST);
        }
            ...
            if (startTask_TaskList != oldStartTask_TaskList)
            {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            taskmodelPackage.TASK_LIST__START_TASK_TASK_LIST, oldStartTask_TaskList, startTask_TaskList));
            }
        }
    ...
    public void setStartTask_TaskList(Task newStartTask_TaskList) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, taskmodelPackage.TASK_LIST__START_TASK_TASK_LIST,
                    oldStartTask_TaskList, startTask_TaskList));
    }
    ...
    public EList<Alternative> getAlternative_TaskList() {
        ...
        {
            alternative_TaskList = new EObjectContainmentEList<Alternative>(Alternative.class, this,
                    taskmodelPackage.TASK_LIST__ALTERNATIVE_TASK_LIST);
        }
