...
public class taskmodelPackageImpl extends EPackageImpl implements taskmodelPackage {
    ...
    public static taskmodelPackage init() {
        if (isInited)
            return (taskmodelPackage) EPackage.Registry.INSTANCE.getEPackage(taskmodelPackage.eNS_URI);

        // Obtain or create and register package
        taskmodelPackageImpl thetaskmodelPackage = (taskmodelPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof taskmodelPackageImpl ? EPackage.Registry.INSTANCE
                .get(eNS_URI) : new taskmodelPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getTask_ProbabilityOfExecution(), ecorePackage.getEDouble(), "probabilityOfExecution", null, 1,
                1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, !IS_ORDERED);
        initEAttribute(getTask_FailureProbability(), ecorePackage.getEDouble(), "failureProbability", null, 1, 1,
                Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        initEAttribute(getTask_MeanDemandedTime(), ecorePackage.getEDouble(), "meanDemandedTime", null, 1, 1,
                Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        initEReference(getTask_Repositorycomponent(), theRepositoryPackage.getRepositoryComponent(), null,
                "repositorycomponent", null, 1, 1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getTask_Allocationcontext(), theAllocationPackage.getAllocationContext(), null,
                "allocationcontext", null, 0, 1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getTask_Edge_Task(), this.getEdge(), null, "edge_Task", null, 0, -1, Task.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        initEReference(getTask_Abstractaction(), theSeffPackage.getAbstractAction(), null, "abstractaction", null, 1,
                1, Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        EOperation op = addEOperation(taskEClass, ecorePackage.getEBoolean(), "sumOfProbabilitiesMustBeOne", 0, 1,
        ...
        initEAttribute(getEdge_TransitionProbability(), ecorePackage.getEDouble(), "transitionProbability", null, 1, 1,
                Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                !IS_ORDERED);
        initEReference(getEdge_Successor_Edge(), this.getTask(), null, "successor_Edge", null, 1, 1, Edge.class,
        ...
        initEReference(getTaskList_Task_TaskList(), this.getTask(), null, "task_TaskList", null, 0, -1, TaskList.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getTaskList_StartTask_TaskList(), this.getTask(), null, "startTask_TaskList", null, 0, 1,
                TaskList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
        initEReference(getTaskList_Alternative_TaskList(), this.getAlternative(), null, "alternative_TaskList", null,
                0, -1, TaskList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
                !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(alternativeEClass, Alternative.class, "Alternative", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getAlternative_Alternativetasks_Alternative(), this.getAlternativeTask(), null,
                "alternativetasks_Alternative", null, 1, -1, Alternative.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

        initEClass(alternativeTaskEClass, AlternativeTask.class, "AlternativeTask", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getAlternativeTask_Task_AlternativeTask(), this.getTask(), null, "task_AlternativeTask", null,
                0, 1, AlternativeTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
