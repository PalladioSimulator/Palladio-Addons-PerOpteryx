package org.palladiosimulator.editors.sirius.repository.enriched;
...
public class Activator extends AbstractUIPlugin {
    // The plug-in ID
    public static final String PLUGIN_ID = "repository.enriched";
    ...
    public static final String VIEWPOINT_NAME = "Repository Enriched";
    public static final String REPRESENTATION_NAME= "Enriched Repository Diagram";
